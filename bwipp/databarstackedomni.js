...
BWIPJS.bwipp["databarstackedomni"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.databarstackedomniBadAI"; //ident
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.databarstackedomniBadLength"; //ident
	...
	function $f8(){
		this.stk[this.ptr++]="bwipp.databarstackedomniBadCharacter"; //ident
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.databarstackedomniBadCheckDigit"; //ident
