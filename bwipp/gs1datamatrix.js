...
BWIPJS.bwipp["gs1datamatrix"]=function() {
	...
	function $f12(){
		...
		if (t13 < 0) t=this.stk.splice(this.ptr-t12, -t13);
		else t=this.stk.splice(this.ptr-t12, t12-t13);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
	}
	function $f13(){
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		if (t17 < 0) t=this.stk.splice(this.ptr-t16, -t17);
		else t=this.stk.splice(this.ptr-t16, t16-t17);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.xget("expand");
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
		this.ptr-=3;
	...
	function $f15(){
		...
		if (t27 < 0) t=this.stk.splice(this.ptr-t26, -t27);
		else t=this.stk.splice(this.ptr-t26, t26-t27);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
		this.ptr-=3;
	}
	...
	function $f18(){
		...
		if (t40 < 0) t=this.stk.splice(this.ptr-t39, -t40);
		else t=this.stk.splice(this.ptr-t39, t39-t40);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
		this.ptr-=3;
	}
	...
	this.xget("barcode");
	this.xget("options");
	this.stk[this.ptr++]=this.get("datamatrix");
	t=this.stk[--this.ptr];
