...
BWIPJS.bwipp["gs1-cc"]=function() {
	function $f0(){
		//#line 18367: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 18368: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 18370: currentdict end /options exch def
	...
	function $f5(){
		//#line 18372: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 18385: ccversion (c) ne {4} {linwidth 52 sub 17 idiv} ifelse
		this.stk[this.ptr++]=4;
	}
	function $f7(){
		//#line 18385: ccversion (c) ne {4} {linwidth 52 sub 17 idiv} ifelse
	...
	function $f8(){
		...
		//#line 18386: /databaromni            4
		this.stk[this.ptr++]="databaromni";
		this.stk[this.ptr++]=4;
		//#line 18387: /databarstacked         2
		this.stk[this.ptr++]="databarstacked";
		this.stk[this.ptr++]=2;
		//#line 18388: /databarstackedomni     2
		this.stk[this.ptr++]="databarstackedomni";
		this.stk[this.ptr++]=2;
		//#line 18389: /databartruncated       4
		this.stk[this.ptr++]="databartruncated";
		this.stk[this.ptr++]=4;
		//#line 18390: /databarlimited         3
		this.stk[this.ptr++]="databarlimited";
		this.stk[this.ptr++]=3;
		//#line 18391: /databarexpanded        4
		this.stk[this.ptr++]="databarexpanded";
		this.stk[this.ptr++]=4;
		//#line 18392: /databarexpandedstacked 4
		this.stk[this.ptr++]="databarexpandedstacked";
		this.stk[this.ptr++]=4;
		//#line 18393: >> lintype get /cccolumns exch def 
		var t = {};
	...
	function $f9(){
		//#line 18404: dup out exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		//#line 18405: length j add 1 add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18406: pop
		this.ptr--;
		//#line 18407: dup 0 3 getinterval cvi out exch j 1 sub exch put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		...
		this.ptr-=3;
		//#line 18408: dup length 3 sub 3 exch getinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=3;
	...
	function $f10(){
		//#line 18410: dup out exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18411: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18412: out 0 j getinterval exit
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("j");
	...
	function $f12(){
		//#line 18398: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18399: /out in length string def
	...
	function $f13(){
		//#line 18422: dup () eq {exit} if
		return -1;
	}
	function $f14(){
		//#line 18426: exch pop exch 3 1 roll 
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=3;
	...
	function $f16(){
		...
		//#line 18430: [ ais aload pop counttomark 2 add index ] /ais exch def
		this.stk[this.ptr++]=Infinity;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18431: aival 3 1 roll expand put
	...
	function $f17(){
		//#line 18436: /isupper {dup 65 ge exch 90 le and} bind def  % A-Z
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f18(){
		//#line 18437: /isnum0  {dup 48 ge exch 57 le and} bind def  % 0-9
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f19(){
		//#line 18438: /isnum1  {dup 49 ge exch 57 le and} bind def  % 1-9
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f20(){
		//#line 18444: -1 (10) exit
		this.stk[this.ptr++]=-1;
		this.stk[this.ptr++]=BWIPJS.psstring("10");
		return -1;
	}
	function $f21(){
		//#line 18443: ais 0 get (10) eq ais 0 get (11) eq or ais 0 get (17) eq or {
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f22(){
		//#line 18454: 0 (11) exit
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=BWIPJS.psstring("11");
		return -1;
	}
	function $f23(){
		//#line 18453: v 0 get isupper {
	...
	function $f24(){
		//#line 18460: 1 (11) exit
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=BWIPJS.psstring("11");
		return -1;
	}
	function $f25(){
		//#line 18458: v 0 get isnum1
		var t=this.dstk.get("v");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18459: v 1 get isupper and {
		var t=this.dstk.get("v");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f26(){
		//#line 18467: 2 (11) exit
		this.stk[this.ptr++]=2;
		this.stk[this.ptr++]=BWIPJS.psstring("11");
		return -1;
	}
	function $f27(){
		//#line 18464: v 0 get isnum1
		var t=this.dstk.get("v");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
		...
		this.ptr--;
		//#line 18466: v 2 get isupper and {
		var t=this.dstk.get("v");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f28(){
		//#line 18475: 3 (11) exit
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=BWIPJS.psstring("11");
		return -1;
	}
	function $f29(){
		//#line 18471: v 0 get isnum1
		var t=this.dstk.get("v");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
		...
		this.ptr--;
		//#line 18474: v 3 get isupper and {
		var t=this.dstk.get("v");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f33(){
		//#line 18491: string dup length 1 sub 0 exch 1 exch {1 index exch 48 put} for
		this.stk[this.ptr++]=1;
		if (this.stk[this.ptr-1] >= this.ptr) throw "index: underflow";
		this.stk[this.ptr-1]=this.stk[this.ptr-2-this.stk[this.ptr-1]];
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f34(){
		...
		//#line 18492: dup 3 -1 roll 2 2 index length string cvrs dup length 2 index length exch sub exch putinterval 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=-1;
		var b=this.stk[--this.ptr]; var a=this.stk[--this.ptr];
	...
	function $f35(){
		//#line 18496: 65 1 90 {dup 65 sub 5 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=65;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=5;
	...
	function $f36(){
		//#line 18497: 48 1 57 {dup 4 add 6 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=6;
	...
	function $f37(){
		//#line 18505: dup 0 get 65 eq {dup 0 94 put} if 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
	...
	function $f38(){
		//#line 18506: dup 1 get 65 eq {dup 1 94 put} if 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=94;
		if (this.stk[this.ptr-3] instanceof BWIPJS.psstring || this.stk[this.ptr-3] instanceof BWIPJS.psarray)
	...
	function $f39(){
		//#line 18503: dup (00) 2 string copy dup 3 -1 roll 11 2 string cvrs
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18504: dup length 2 exch sub exch putinterval 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=2;
		...
		//#line 18507: exch 8 add
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=8;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 18508: (0000000) 7 string copy dup 3 -1 roll 2 7 string cvrs 
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18509: dup length 7 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=7;
	...
	function $f40(){
		//#line 18515: 48 1 57 {dup 43 sub 5 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f41(){
		//#line 18517: 65 1 90 {dup 33 sub 6 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f42(){
		//#line 18519: 44 1 47 {dup 15 add 6 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f43(){
		//#line 18525: 48 1 57 {dup 43 sub 5 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=43;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=5;
	...
	function $f44(){
		//#line 18527: 65 1 90 {dup 1 sub 7 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=7;
	...
	function $f45(){
		//#line 18528: 97 1 122 {dup 7 sub 7 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=7;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=7;
	...
	function $f46(){
		//#line 18531: 37 1 47 {dup 197 add 8 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f47(){
		//#line 18532: 58 1 63 {dup 187 add 8 tobin} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f48(){
		//#line 18548: 4 -1 roll {48 sub} forall
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f49(){
		//#line 18549: ais 0 get (11) eq {0} {1} ifelse
		this.stk[this.ptr++]=0;
	}
	function $f50(){
		//#line 18549: ais 0 get (11) eq {0} {1} ifelse
	...
	function $f51(){
		//#line 18541: aival ais 0 get get
		var t=this.dstk.get("aival");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 18542: dup 0 2 getinterval cvi 384 mul exch
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 18543: dup 2 2 getinterval cvi 1 sub 32 mul exch
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 18544: 4 2 getinterval cvi add add 
		this.stk[this.ptr++]=4;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 18545: (0000000000000000) 16 string copy dup 3 -1 roll 2 16 string cvrs
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18546: dup length 16 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=16;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18551: /ais ais 1 ais length 1 sub getinterval def
		this.stk[this.ptr++]="ais";
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f54(){
		//#line 18558: ais length 1 gt {/gpf [ gpf aload pop fnc1 ] def} if  % TODO: check
	...
	function $f55(){
		//#line 18557: /gpf [ aival (10) get {} forall ] def
		this.stk[this.ptr++]="gpf";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("aival");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18559: /ais ais 1 ais length 1 sub getinterval def
		this.stk[this.ptr++]="ais";
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f56(){
		//#line 18561: /gpf [fnc1] def  % TODO: check
		this.stk[this.ptr++]="gpf";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("fnc1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f58(){
		//#line 18564: /cdf [ cdf aload pop 0 0 0 0 0 1 1 1 1 ] def
		this.stk[this.ptr++]="cdf";
		this.stk[this.ptr++]=Infinity;
	...
	function $f59(){
		//#line 18540: ais 0 get (11) eq ais 0 get (17) eq or {
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
		...
		//#line 18567: /mode (numeric) def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("numeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f60(){
		//#line 18574: ai90 npre 1 add ai90 length npre sub 1 sub getinterval
	...
	function $f62(){
		//#line 18579: /nalpha 0 ai90rem {dup 65 ge exch 90 le and {1 add} if} forall def
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f63(){
	...
	function $f64(){
		//#line 18580: /nnums  0 ai90rem {dup 48 ge exch 57 le and {1 add} if} forall def
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f65(){
	...
	function $f66(){
		//#line 18581: /mode nalpha nnums gt {(alpha)} {(numeric)} ifelse def
	...
	function $f68(){
		//#line 18582: nalpha nnums add ai90rem length ne {/mode (alphanumeric) def} if
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("alphanumeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f69(){
		//#line 18585: mode (alphanumeric) eq {0} if   
		this.stk[this.ptr++]=0;
	}
	function $f70(){
		//#line 18586: mode (numeric) eq {1 0} if   
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=0;
	}
	function $f71(){
		//#line 18587: mode (alpha) eq {1 1} if   
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
	}
	function $f72(){
		//#line 18589: /ais1 ais length 1 gt {ais 1 get} {-1} ifelse def
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f74(){
		//#line 18591: /cdf [ cdf aload pop ais1 (21) eq {1 0} {1 1} ifelse ] def
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=0;
	}
	function $f75(){
	...
	function $f77(){
		//#line 18593: /cdf [ cdf aload pop 0 ] def
		this.stk[this.ptr++]="cdf";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("cdf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f78(){
		//#line 18595: /nval npre 0 ne {ai90 0 npre getinterval cvi} {0} ifelse def
		var t=this.dstk.get("ai90");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("npre");
	...
	function $f80(){
		//#line 18597: length exch pop exch pop
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 18598: /aval exch def
		this.stk[this.ptr++]="aval";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f81(){
		//#line 18600: pop /aval -1 def
		this.ptr--;
		this.stk[this.ptr++]="aval";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f82(){
		//#line 18605: [ exch {48 sub} forall ] /nbits exch def
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f83(){
		//#line 18608: [ exch {48 sub} forall ] /abits exch def
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f84(){
		//#line 18603: (00000) 5 string copy dup nval 2 5 string cvrs
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18604: dup length 5 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=5;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18606: (0000) 4 string copy dup aval 2 4 string cvrs
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18607: dup length 4 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=4;
	...
	function $f85(){
		//#line 18617: [ exch {48 sub} forall ] /nbits exch def
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f86(){
		//#line 18620: [ exch {48 sub} forall ] /abits exch def
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f87(){
		//#line 18615: (0000000000) 10 string copy dup nval 2 10 string cvrs
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18616: dup length 10 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=10;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18618: (00000) 5 string copy dup ai90 npre get 65 sub 2 5 string cvrs
		this.stk[this.ptr++]=BWIPJS.psstring("00000");
		this.stk[this.ptr++]=5;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18619: dup length 5 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=5;
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 18623: 1 1 1 1 1
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		//#line 18624: nbits aload pop
		var t=this.dstk.get("nbits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-1];
		for (var i = 0; i < t.length; i++) this.stk[this.ptr-1+i]=t.get(i);
	...
	function $f89(){
		//#line 18629: /gpf [ ai90rem {} forall ais length 1 gt {fnc1} if ] def
		var t=this.dstk.get("fnc1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f90(){
	...
	function $f91(){
		//#line 18631: /encs mode (alpha) eq {alpha} {alphanumeric} ifelse def
	...
	function $f94(){
		//#line 18632: /in [ ai90rem {} forall ais length 1 gt {fnc1} if ] def
		var t=this.dstk.get("fnc1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f95(){
		//#line 18637: dup [ exch {48 sub} forall ] out exch j exch putinterval
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f96(){
		//#line 18636: in exch get encs exch get 
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18638: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f97(){
		//#line 18645: ais length 1 gt mode (alpha) ne or {/mode (numeric) def} if
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("numeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f98(){
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18633: /out in length 6 mul array def
		this.stk[this.ptr++]="out";
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18635: 0 1 in length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 18642: out 0 j getinterval aload pop
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("j");
	...
	function $f100(){
		//#line 18655: ais length 0 ne {/gpf [gpf aload pop fnc1] def} if
		this.stk[this.ptr++]="gpf";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f101(){
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 18652: aival ais1 get {} forall
		var t=this.dstk.get("aival");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ais1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18654: /ais ais 1 ais length 1 sub getinterval def
		this.stk[this.ptr++]="ais";
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f102(){
		//#line 18649: ais1 (21) eq ais1 (8004) eq or {
		var t=this.dstk.get("ais1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("21");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	function $f103(){
		//#line 18571: /cdf [ 1 1 ] def
		this.stk[this.ptr++]="cdf";
		this.stk[this.ptr++]=BWIPJS.psarray([1,1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18572: /ai90 aival (90) get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18573: npre 1 add ai90 length ne {
		var t=this.dstk.get("npre");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18590: ais1 (21) eq ais1 (8004) eq or { 
		var t=this.dstk.get("ais1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("21");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18596: (BDHIJKLNPQRSTVXZ) ai90 npre 1 getinterval search {
		...
		//#line 18602: nval 31 lt aval -1 ne and {
		var t=this.dstk.get("nval");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18647: /ais ais 1 ais length 1 sub getinterval def
		this.stk[this.ptr++]="ais";
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f106(){
		//#line 18673: (00) 2 string copy dup dup 1 5 -1 roll 48 add put aifixed 3 1 roll put
		this.stk[this.ptr++]=BWIPJS.psstring("00");
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
	...
	function $f109(){
		//#line 18681: 10 2 string cvrs dup aifixed 3 1 roll put
		this.stk[this.ptr++]=10;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		var t=this.stk[this.ptr-3].toString(this.stk[this.ptr-2]).toUpperCase();
	...
	function $f112(){
		//#line 18695: gpf length 1 add array
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		//#line 18696: dup 0 gpf putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18697: dup gpf length fnc1 put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.ptr-=3;
		//#line 18698: /gpf exch def
		this.stk[this.ptr++]="gpf";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f113(){
		//#line 18686: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18687: /ai ais i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18688: /val aival ai get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18689: gpf length ai length add val length add array
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		//#line 18690: dup 0 gpf putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18691: dup gpf length ai [ exch {} forall ] putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18692: dup gpf length ai length add val [ exch {} forall ] putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18693: /gpf exch def
		this.stk[this.ptr++]="gpf";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18694: i ais length 1 sub ne aifixed ai 0 2 getinterval known not and {  % Append FNC1
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ais");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f114(){
		//#line 18718: -1 bitcaps {dup used ge {exch} if pop} forall
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	}
	function $f115(){
		//#line 18718: -1 bitcaps {dup used ge {exch} if pop} forall
	...
	function $f116(){
		//#line 18719: dup -1 ne {used sub} if
		var t=this.dstk.get("used");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f117(){
		...
		this.stk[this.ptr++]="b";
		this.stk[this.ptr++]=Infinity;
		//#line 18713: [ 336  296 256 208 160 104  56]
		this.stk[this.ptr++]=BWIPJS.psarray([336,296,256,208,160,104,56]);
		//#line 18714: [ 768  648 536 416 304 208 152 112  72 32]
		this.stk[this.ptr++]=BWIPJS.psarray([768,648,536,416,304,208,152,112,72,32]);
		//#line 18715: [1184 1016 840 672 496 352 264 208 152 96 56]
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 18717: >> ccversion get cccolumns 2 sub get /bitcaps exch def
		var t = {};
		for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
			if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
			t[this.stk[i-1]]=this.stk[i];
	...
	function $f118(){
		//#line 18723: m   40 le               {8 } if
		this.stk[this.ptr++]=8;
	}
	function $f119(){
		//#line 18724: m   41 ge m  160 le and {16} if
		this.stk[this.ptr++]=16;
	}
	function $f120(){
		//#line 18725: m  161 ge m  320 le and {32} if
		this.stk[this.ptr++]=32;
	}
	function $f121(){
		//#line 18726: m  321 ge               {64} if
		this.stk[this.ptr++]=64;
	}
	function $f122(){
		//#line 18730: m c idiv 90 gt {/c c 1 add def} if
		this.stk[this.ptr++]="c";
	...
	function $f123(){
		//#line 18733: used 8296 le {tgt used sub} {-1} ifelse
	...
	function $f125(){
		//#line 18721: << /c -1 >> ccversion get pop  % Assert cc-c
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]="c";
		this.stk[this.ptr++]=-1;
		var t = {};
		...
		this.ptr--;
		this.ptr--;
		//#line 18722: /m used 8 div ceiling cvi dup 6 idiv 5 mul exch 6 mod add def
		this.stk[this.ptr++]="m";
		var t=this.dstk.get("used");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=8;
		...
		//#line 18727: /eccws exch def
		this.stk[this.ptr++]="eccws";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18728: /m m eccws add 3 add def
		this.stk[this.ptr++]="m";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18729: /c linwidth 52 sub 17 idiv def
		this.stk[this.ptr++]="c";
		var t=this.dstk.get("linwidth");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=52;
		...
		//#line 18731: /r m c div ceiling cvi def
		this.stk[this.ptr++]="r";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("c");
		...
		this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18732: /tgt c r mul eccws sub 3 sub dup 5 idiv 6 mul exch 5 mod add 8 mul def
	...
	function $f126(){
		//#line 18738: /ccversion (b) def
		this.stk[this.ptr++]="ccversion";
		this.stk[this.ptr++]=BWIPJS.psstring("b");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f127(){
		//#line 18741: /ccversion (c) def
		this.stk[this.ptr++]="ccversion";
		this.stk[this.ptr++]=BWIPJS.psstring("c");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18742: /cccolumns linwidth 52 sub 17 idiv def
		this.stk[this.ptr++]="cccolumns";
		var t=this.dstk.get("linwidth");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=52;
	...
	function $f128(){
		//#line 18744: /ccversion -1 def
		this.stk[this.ptr++]="ccversion";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f129(){
		//#line 18740: ccversion (b) eq lintype (gs1-128) eq and {
		var t=this.dstk.get("ccversion");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("b");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	function $f131(){
		//#line 18704: /used exch def
		this.stk[this.ptr++]="used";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18705: ccversion (c) ne {  % cc-a or cc-b
		var t=this.dstk.get("ccversion");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("c");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 18735: dup -1 eq {  % Upgrade CC-A to CC-B or CC-B to CC-C to fit
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=-1;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].toString()==this.stk[this.ptr-1];
	...
	function $f132(){
		//#line 18752: dup /raw ne {exch get} {pop} ifelse
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
	...
	function $f135(){
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 18754: dup length exch
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 18755: gpfenc exch j exch putinterval
	...
	function $f136(){
		//#line 18760: /numericruns [ gpf length {0} repeat 0 -1 ] def
		this.stk[this.ptr++]=0;
	}
	function $f137(){
		//#line 18761: /alphanumericruns [ gpf length {0} repeat 0 ] def
		this.stk[this.ptr++]=0;
	}
	function $f138(){
		//#line 18762: /nextiso646only [ gpf length {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f139(){
		//#line 18767: dup 0 gpf i get dup fnc1 eq {pop 94} if put 
		this.ptr--;
		this.stk[this.ptr++]=94;
	}
	function $f140(){
		//#line 18768: i gpf length 1 sub lt {dup 1 gpf i 1 add get dup fnc1 eq {pop 94} if put} if
		this.ptr--;
		this.stk[this.ptr++]=94;
	}
	function $f141(){
	...
	function $f142(){
		//#line 18770: numericruns i numericruns i 2 add get 2 add put
	...
	function $f143(){
		//#line 18772: numericruns i 0 put
		var t=this.dstk.get("numericruns");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f144(){
		//#line 18775: alphanumericruns i alphanumericruns i 1 add get 1 add put
	...
	function $f145(){
		//#line 18777: alphanumericruns i 0 put
		var t=this.dstk.get("alphanumericruns");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f146(){
		//#line 18780: nextiso646only i 0 put
	...
	function $f147(){
		//#line 18782: nextiso646only i nextiso646only i 1 add get 1 add put
		var t=this.dstk.get("nextiso646only");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f148(){
		//#line 18764: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18765: gpf i get
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18774: dup alphanumeric exch known {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("alphanumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 18779: dup iso646 exch known exch alphanumeric exch known not and {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f149(){
		//#line 18790: i gpf length eq {exit} if
		return -1;
	}
	function $f150(){
		//#line 18796: dup 0 gpf i get dup fnc1 eq {pop 94} if put
		this.ptr--;
		this.stk[this.ptr++]=94;
	}
	function $f151(){
		//#line 18797: dup 1 gpf i 1 add get dup fnc1 eq {pop 94} if put
		this.ptr--;
		this.stk[this.ptr++]=94;
	}
	function $f152(){
		//#line 18799: numeric encode
		var t=this.dstk.get("numeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("encode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18800: /i i 2 add def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
	...
	function $f153(){
		...
		this.ptr-=3;
		//#line 18798: dup numeric exch known {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("numeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 18803: pop
		this.ptr--;
		//#line 18804: lalphanumeric numeric encode 
		...
		var t=this.dstk.get("encode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18805: /mode (alphanumeric) def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("alphanumeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18806: exit
	...
	function $f154(){
		//#line 18809: lalphanumeric numeric encode
		var t=this.dstk.get("lalphanumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("numeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("encode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18810: /mode (alphanumeric) def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("alphanumeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18811: exit
	...
	function $f155(){
		//#line 18815: (000000) 6 string copy 0 rem getinterval
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		//#line 18816: dup gpf i get 47 sub 2 4 string cvrs
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18817: dup length 4 exch sub exch putinterval /raw encode
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=4;
	...
	function $f156(){
		//#line 18821: 2 string dup 0 gpf i get put dup 1 94 put numeric encode 
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
	...
	function $f157(){
		//#line 18808: gpf i get dup 48 lt exch 57 gt or {
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18813: /rem cdf length j add rembits def
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18814: rem 4 ge rem 6 le and {  % C1 + 1 into 4 to 6 bits
		var t=this.dstk.get("rem");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]>=this.stk[this.ptr-1]; this.ptr--;
	...
	function $f158(){
		//#line 18794: i gpf length 2 sub le {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f159(){
		//#line 18830: fnc1 alphanumeric encode
		var t=this.dstk.get("fnc1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("alphanumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("encode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18831: /mode (numeric) def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("numeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18832: /i i 1 add def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f160(){
		//#line 18836: liso646 alphanumeric encode
	...
	function $f161(){
		//#line 18841: lnumeric alphanumeric encode
	...
	function $f162(){
		//#line 18846: lnumeric alphanumeric encode
		var t=this.dstk.get("lnumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("alphanumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f163(){
		...
		//#line 18835: gpf i get dup iso646 exch known exch alphanumeric exch known not and {
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18840: numericruns i get 6 ge {
		var t=this.dstk.get("numericruns");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18845: numericruns i get dup 4 ge exch i add gpf length eq and {
		var t=this.dstk.get("numericruns");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18850: gpf i get alphanumeric encode
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f164(){
		...
		var t=this.dstk.get("encode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18858: /mode (numeric) def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("numeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18859: /i i 1 add def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f165(){
		//#line 18863: lnumeric iso646 encode
		var t=this.dstk.get("lnumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("iso646");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f166(){
		//#line 18868: lalphanumeric iso646 encode
		var t=this.dstk.get("lalphanumeric");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("iso646");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("encode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18869: /mode (alphanumeric) def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=BWIPJS.psstring("alphanumeric");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18870: exit
	...
	function $f167(){
		...
		//#line 18862: numericruns i get 4 ge nextiso646only i get 10 ge and {
		var t=this.dstk.get("numericruns");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18867: alphanumericruns i get 5 ge nextiso646only i get 10 ge and {
		var t=this.dstk.get("alphanumericruns");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18872: gpf i get iso646 encode
		var t=this.dstk.get("gpf");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f168(){
		...
		//#line 18828: mode (alphanumeric) eq {
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("alphanumeric");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	function $f169(){
		...
		//#line 18791: {  % not a loop but common exit point
	...
	function $f170(){
		//#line 18886: pad i [ 0 0 1 0 0 ] 0 pad length i sub 5 2 copy gt {exch} if pop getinterval putinterval 
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	}
	function $f171(){
		//#line 18885: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18886: pad i [ 0 0 1 0 0 ] 0 pad length i sub 5 2 copy gt {exch} if pop getinterval putinterval 
	...
	function $f172(){
		//#line 18889: /pad [ 0 0 0 0 pad aload pop ] 0 pad length getinterval def
	...
	function $f173(){
		//#line 18892: /pad [ 1 1 1 1 1 pad aload pop ] 0 pad length getinterval def
		this.stk[this.ptr++]="pad";
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
	...
	function $f174(){
		//#line 18884: 0 5 pad length 1 sub {  % Fill with 00100
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=5;
		var t=this.dstk.get("pad");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18888: mode (numeric) eq {  % Prefix shift from numeric to ASCII
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("numeric");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 18891: mode (alpha) eq {  % Prefix FNC1
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("alpha");
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	function $f175(){
		//#line 18906: 68 {7 array} repeat
		this.stk[this.ptr++]=7;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	}
	function $f176(){
		//#line 18912: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18913: /v pwr928 j 1 sub get i get 2 mul v 928 idiv add def
		this.stk[this.ptr++]="v";
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18914: pwr928 j get i v 928 mod put 
		var t=this.dstk.get("pwr928");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f177(){
		...
		//#line 18916: pwr928 j get 0 pwr928 j 1 sub get 0 get 2 mul v 928 idiv add put
		var t=this.dstk.get("pwr928");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f178(){
		//#line 18918: /cws [ 28 {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f179(){
		//#line 18921: b bits length eq {exit} if
		return -1;
	}
	function $f180(){
		//#line 18922: /bs bits b 69 bits length b sub 2 copy gt {exch} if pop getinterval def
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	}
	function $f181(){
		//#line 18929: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18930: cs j 2 copy get
		...
		this.ptr--;
		//#line 18931: pwr928 i get j 7 add csl sub get
		var t=this.dstk.get("pwr928");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 18932: bs bsl i sub 1 sub get
	...
	function $f182(){
		//#line 18927: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18928: 0 1 csl 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("csl");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f183(){
		//#line 18937: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18938: cs i 1 sub 2 copy get cs i get 928 idiv add put
		var t=this.dstk.get("cs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 18939: cs i 2 copy get 928 mod put
		var t=this.dstk.get("cs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f184(){
		...
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18924: /cs cws c bsl 10 idiv 1 add getinterval def
	...
	function $f185(){
		//#line 18947: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18948: (^   ) 4 string copy dup cws i get 10 4 string cvrs
		this.stk[this.ptr++]=BWIPJS.psstring("^   ");
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 18949: dup length 4 exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=4;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18950: barcode i 4 mul 3 -1 roll putinterval
	...
	function $f186(){
		...
		//#line 18944: /cws cws 0 c getinterval def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18945: /barcode cws length 4 mul string def
		...
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18946: 0 1 cws length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18952: options (dontdraw) true put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 18953: options (cca) true put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 18954: options (columns) cccolumns put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 18955: /args barcode options //micropdf417 exec def
	...
	function $f187(){
		//#line 18962: bits i 8 mul 8 getinterval 0 exch {add 2 mul} forall 2 idiv
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	}
	function $f188(){
		//#line 18961: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18962: bits i 8 mul 8 getinterval 0 exch {add 2 mul} forall 2 idiv
		...
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		//#line 18963: barcode exch i exch put
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("i");
	...
	function $f189(){
		//#line 18959: /barcode bits length 8 idiv string def
		this.stk[this.ptr++]="barcode";
		var t=this.dstk.get("bits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18960: 0 1 barcode length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18965: options (dontdraw) true put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("dontdraw");
		this.stk[this.ptr++]=true;
		...
		this.ptr-=3;
		//#line 18966: options (ccb) true put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 18967: options (columns) cccolumns put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("columns");
		var t=this.dstk.get("cccolumns");
		...
		this.ptr-=3;
		//#line 18968: /args barcode options //micropdf417 exec def
		this.stk[this.ptr++]="args";
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("options");
	...
	function $f190(){
		//#line 18975: bits i 8 mul 8 getinterval 0 exch {add 2 mul} forall 2 idiv
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	}
	function $f191(){
		//#line 18974: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18975: bits i 8 mul 8 getinterval 0 exch {add 2 mul} forall 2 idiv
		...
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		//#line 18976: barcode exch i exch put
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("i");
	...
	function $f192(){
		//#line 18972: /barcode bits length 8 idiv string def
		this.stk[this.ptr++]="barcode";
		var t=this.dstk.get("bits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18973: 0 1 barcode length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18978: options (dontdraw) true put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("dontdraw");
		this.stk[this.ptr++]=true;
		...
		this.ptr-=3;
		//#line 18979: options (ccc) true put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 18980: options (columns) cccolumns put
		var t=this.dstk.get("options");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=BWIPJS.psstring("columns");
		var t=this.dstk.get("cccolumns");
		...
		this.ptr-=3;
		//#line 18981: /args barcode options //pdf417 exec def
		this.stk[this.ptr++]="args";
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("options");
	...
	//#line 18352: 20 dict begin            % Confine variables to local scope
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 18354: /options exch def  % We are given an option string
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18355: /barcode exch def  % We are given a barcode string
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18357: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18358: /ccversion (a) def
	this.stk[this.ptr++]="ccversion";
	this.stk[this.ptr++]=BWIPJS.psstring("a");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18359: /cccolumns -1 def
	this.stk[this.ptr++]="cccolumns";
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18360: /lintype () def
	this.stk[this.ptr++]="lintype";
	this.stk[this.ptr++]=BWIPJS.psstring("");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18361: /linwidth -1 def
	this.stk[this.ptr++]="linwidth";
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18364: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 18374: /cccolumns cccolumns cvi def
	this.stk[this.ptr++]="cccolumns";
	var t=this.dstk.get("cccolumns");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18375: /linwidth linwidth cvi def
	this.stk[this.ptr++]="linwidth";
	var t=this.dstk.get("linwidth");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18378: cccolumns -1 eq {
	var t=this.dstk.get("cccolumns");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=-1;
	if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	this.stk[this.ptr++]=BWIPJS.psarray([]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18419: /aival 2 dict def
	this.stk[this.ptr++]="aival";
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-1]={};
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18420: barcode dup length 1 sub 1 exch getinterval
	var t=this.dstk.get("barcode");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	...
	//#line 18485: /method exch def
	this.stk[this.ptr++]="method";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18486: /npre exch def
	this.stk[this.ptr++]="npre";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18488: /fnc1 -1 def /lnumeric -2 def /lalphanumeric -3 def /liso646 -4 def
	...
	//#line 18520: lnumeric (000)
	var t=this.dstk.get("lnumeric");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=BWIPJS.psstring("000");
	//#line 18521: liso646 (00100)
	var t=this.dstk.get("liso646");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 18529: 33 (11101000)
	this.stk[this.ptr++]=33;
	this.stk[this.ptr++]=BWIPJS.psstring("11101000");
	//#line 18530: 34 (11101001)
	...
	this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18539: method (10) eq {  % TODO: fixme
	...
	//#line 18669: /aifixed 23 dict def
	...
	//#line 18685: 0 1 ais length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("ais");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18763: gpf length 1 sub -1 0 {
	var t=this.dstk.get("gpf");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	//#line 18787: /gpfenc 8296 array def
	this.stk[this.ptr++]="gpfenc";
	this.stk[this.ptr++]=8296;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18788: /i 0 def /j 0 def
	this.stk[this.ptr++]="i";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="j";
	...
	//#line 18879: /gpf gpfenc 0 j getinterval def
	this.stk[this.ptr++]="gpf";
	var t=this.dstk.get("gpfenc");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18882: /pad cdf length gpf length add rembits array def
	this.stk[this.ptr++]="pad";
	var t=this.dstk.get("cdf");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 18985: dontdraw not //renmatrix if
