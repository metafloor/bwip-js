...
BWIPJS.bwipp["upcecomposite"]=function() {
	...
	function $f0(){
		//#line 19238: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 19239: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 19241: currentdict end /options exch def
	...
	function $f5(){
		//#line 19243: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 19247: /linear exch def
		this.stk[this.ptr++]="linear";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 19248: pop
		this.ptr--;
		//#line 19249: /comp exch def
	...
	function $f8(){
		//#line 19258: 0 1  49 {0} repeat  1 0
		this.stk[this.ptr++]=0;
	}
	function $f9(){
		//#line 19259: 1 0  49 {0} repeat  0 1
		this.stk[this.ptr++]=0;
	}
	function $f10(){
		//#line 19260: 0 1  49 {0} repeat  1 0
		this.stk[this.ptr++]=0;
	}
	function $f11(){
		//#line 19282: 0 1  49 {0} repeat  1 0
		this.stk[this.ptr++]=0;
	}
	function $f12(){
		//#line 19283: 1 0  49 {0} repeat  0 1
		this.stk[this.ptr++]=0;
	}
	function $f13(){
		//#line 19284: 0 1  49 {0} repeat  1 0
		this.stk[this.ptr++]=0;
	}
	//#line 19227: 20 dict begin            % Confine variables to local scope
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 19229: /options exch def
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19230: /barcode exch def
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19232: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19235: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=3;
	//#line 19264: /height 6 72 div
	this.stk[this.ptr++]="height";
	this.stk[this.ptr++]=6;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 19265: /width 53 72 div
	this.stk[this.ptr++]="width";
	this.stk[this.ptr++]=53;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 19266: /opt options
	...
	//#line 19269: gsave
	this.gsave();
	//#line 19271: options (lintype) (upce) put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19272: options (inkspread) (0) put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19273: options (dontdraw) true put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19276: linear options //upce exec //renlinear exec
	...
	this.stk[this.ptr++]="pixy";
	this.stk[this.ptr++]=3;
	//#line 19288: /height 6 72 div
	this.stk[this.ptr++]="height";
	this.stk[this.ptr++]=6;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 19289: /width 53 72 div
	this.stk[this.ptr++]="width";
	this.stk[this.ptr++]=53;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 19290: /opt options
	this.stk[this.ptr++]="opt";
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 19291: >> //renmatrix exec
	var t = {};
	for (var i = this.ptr-1; i >= 1 && this.stk[i] !== Infinity; i-=2) {
		if (this.stk[i-1] === Infinity) throw "dict: malformed stack";
		t[this.stk[i-1]]=this.stk[i];
	...
	var t=this.stk[--this.ptr];
	if (t instanceof Function) t.call(this); else this.eval(t);
	//#line 19294: -2 6 rmoveto comp options //gs1-cc exec //renmatrix exec
	this.stk[this.ptr++]=-2;
	this.stk[this.ptr++]=6;
	var y=this.stk[--this.ptr];
	this.rmoveto(this.stk[--this.ptr],y);
