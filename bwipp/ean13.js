...
BWIPJS.bwipp["ean13"]=function() {
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.ean13badLength"; //ident
	...
	function $f13(){
		this.stk[this.ptr++]="bwipp.ean13badCharacter"; //ident
	...
	function $f15(){
		this.stk[this.ptr++]="bwipp.ean13badAddOnLength"; //ident
	...
	function $f19(){
		this.stk[this.ptr++]="bwipp.ean13badCheckDigit"; //ident
