...
BWIPJS.bwipp["pharmacode2"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.pharmacode2BadLength"; //ident
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.pharmacode2badCharacter"; //ident
	...
	function $f9(){
		this.stk[this.ptr++]="bwipp.pharmacode2badValue"; //ident
