...
BWIPJS.bwipp["databartruncated"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.databartruncatedBadAI"; //ident
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.databartruncatedBadLength"; //ident
	...
	function $f8(){
		this.stk[this.ptr++]="bwipp.databartruncatedBadCharacter"; //ident
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.databartruncatedBadCheckDigit"; //ident
