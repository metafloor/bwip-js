...
BWIPJS.bwipp["ean14"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.ean14badAI"; //ident
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.ean14badLength"; //ident
	...
	function $f8(){
		this.stk[this.ptr++]="bwipp.ean14badCharacter"; //ident
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.ean14badCheckDigit"; //ident
