...
BWIPJS.bwipp["sscc18"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.sscc18badAI"; //ident
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.sscc18badLength"; //ident
	...
	function $f8(){
		this.stk[this.ptr++]="bwipp.sscc18badCharacter"; //ident
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.sscc18badCheckDigit"; //ident
