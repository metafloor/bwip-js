...
BWIPJS.bwipp["code2of5"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.code2of5badCharacter"; //ident
	...
	function $f11(){
		this.stk[this.ptr++]="bwipp.code2of5badCheckDigit"; //ident
	...
	function $f13(){
		this.stk[this.ptr++]="bwipp.code2of5badVersion"; //ident
	...
	this.stk[this.ptr++]="versions"; //ident
	this.stk[this.ptr++]=Infinity;
	...
	if (t===undefined) throw new Error("dict: versions: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
