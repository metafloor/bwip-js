...
BWIPJS.bwipp["symbol"]=function() {
	...
	function $f10(){
		this.stk[this.ptr++]="bwipp.symbolUnknownSymbol"; //ident
	...
	this.stk[this.ptr++]="symbols"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]="fima"; //ident
	this.stk[this.ptr++]=$f6;
	this.stk[this.ptr++]="fimb"; //ident
	this.stk[this.ptr++]=$f7;
	this.stk[this.ptr++]="fimc"; //ident
	this.stk[this.ptr++]=$f8;
	this.stk[this.ptr++]="fimd"; //ident
	...
	if (t===undefined) throw new Error("dict: symbols: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
