...
BWIPJS.bwipp["identcode"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.identcodeBadLength"; //ident
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.identcodeBadCharacter"; //ident
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.identcodeBadCheckDigit"; //ident
