...
BWIPJS.bwipp["msi"]=function() {
	...
	function $f10(){
		...
		this.forall(this.stk[--this.ptr],t6);
		this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=0;
	...
	function $f14(){
		...
		if (t19 < 0) t=this.stk.splice(this.ptr-t18, -t19);
		else t=this.stk.splice(this.ptr-t18, t18-t19);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
	...
	function $f19(){
		...
		if (t29 < 0) t=this.stk.splice(this.ptr-t28, -t29);
		else t=this.stk.splice(this.ptr-t28, t28-t29);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
