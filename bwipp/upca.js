...
BWIPJS.bwipp["upca"]=function() {
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.upcAupcEbadCharacter"; //ident
	...
	function $f14(){
		this.stk[this.ptr++]="bwipp.upcAupcEbadNumberSystem"; //ident
	...
	function $f24(){
		this.stk[this.ptr++]="bwipp.upcAbadLength"; //ident
	...
	function $f25(){
		this.stk[this.ptr++]="bwipp.upcAbadCharacter"; //ident
	...
	function $f27(){
		this.stk[this.ptr++]="bwipp.upcAbadAddOnLength"; //ident
	...
	function $f31(){
		this.stk[this.ptr++]="bwipp.upcAbadCheckDigit"; //ident
