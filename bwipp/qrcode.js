...
BWIPJS.bwipp["qrcode"]=function() {
	function $f0(){
		//#line 15578: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 15579: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 15581: currentdict end /options exch def
	...
	function $f5(){
		//#line 15583: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 15592: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		//#line 15593: length j add 1 add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15594: pop
		this.ptr--;
		//#line 15595: dup 0 3 getinterval cvi msg exch j 1 sub exch put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		...
		this.ptr-=3;
		//#line 15596: dup length 3 sub 3 exch getinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=3;
	...
	function $f7(){
		//#line 15598: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15599: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15600: /barcode msg 0 j getinterval def
	...
	function $f9(){
		//#line 15587: /msg barcode length string def
	...
	function $f10(){
		//#line 15615: i barlen eq {exit} if
		return -1;
	}
	function $f11(){
		//#line 15619: /char fncvals barcode i 1 add 4 getinterval get def
	...
	function $f13(){
		//#line 15618: barcode i 1 add get 94 ne {
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f14(){
		...
		//#line 15616: /char barcode i get def
		this.stk[this.ptr++]="char";
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15617: parsefnc char 94 eq and i barlen 4 sub lt and {
	...
	function $f15(){
		//#line 15637: /msg [ msg 1 msglen 1 sub getinterval { dup 37 eq {dup} if } forall ] def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	}
	function $f16(){
		//#line 15637: /msg [ msg 1 msglen 1 sub getinterval { dup 37 eq {dup} if } forall ] def
	...
	function $f17(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15638: /msglen msg length def
	...
	function $f19(){
		//#line 15643: eclevel (unset) eq {/eclevel format (full) eq {(M)} {(L)} ifelse def} if
	...
	function $f34(){
		//#line 15702: string dup length 1 sub 0 exch 1 exch {1 index exch 48 put} for
		this.stk[this.ptr++]=1;
	...
	function $f35(){
		...
		//#line 15703: dup 3 -1 roll 2 2 index length string cvrs dup length 2 index length exch sub exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=-1;
	...
	function $f36(){
		//#line 15709: 0 1 44 {dup charmap exch get exch charvals 3 1 roll put} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f37(){
		//#line 15714: /in [ in { dup -1 eq {pop 37} if } forall ] def
		this.ptr--;
		this.stk[this.ptr++]=37;
	}
	function $f38(){
	...
	function $f40(){
		//#line 15718: k in length eq {exit} if
		return -1;
	}
	function $f41(){
		//#line 15720: charvals in k get get 45 mul charvals in k 1 add get get add 11 tobin
		var t=this.dstk.get("charvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f42(){
		//#line 15723: charvals in k get get 6 tobin
		var t=this.dstk.get("charvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f43(){
		...
		//#line 15719: k in length 1 sub lt {
		var t=this.dstk.get("k");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15726: dup out exch m exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15727: length m add /m exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f44(){
		//#line 15712: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15713: fnc1first {  % FNC1 as %
		...
		//#line 15716: /out in length 11 mul 2 idiv 1 add string def
		...
		//#line 15729: out 0 m getinterval
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("m");
	...
	function $f45(){
		//#line 15736: k in length eq {exit} if
		return -1;
	}
	function $f46(){
		//#line 15738: in k 3 getinterval 0 exch {exch 10 mul 48 sub add} forall 10 tobin
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f48(){
		//#line 15742: in k 2 getinterval 0 exch {exch 10 mul 48 sub add} forall 7 tobin
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=10;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=48;
	...
	function $f50(){
		//#line 15745: in k 1 getinterval 0 exch {exch 10 mul 48 sub add} forall 4 tobin
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=10;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=48;
	...
	function $f52(){
		//#line 15741: k in length 2 sub eq {  % Two final digits
		var t=this.dstk.get("k");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f53(){
		...
		//#line 15737: k in length 2 sub lt {
		var t=this.dstk.get("k");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15749: dup out exch m exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15750: length m add /m exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f54(){
		//#line 15733: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15734: /out in length 10 mul 3 idiv 1 add string def
		this.stk[this.ptr++]="out";
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		//#line 15752: out 0 m getinterval
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("m");
	...
	function $f55(){
		//#line 15758: /in [ in { dup -1 eq {pop 29} if } forall ] def
		this.ptr--;
	...
	function $f58(){
		//#line 15762: /k exch def
		this.stk[this.ptr++]="k";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15763: in k get cvi 8 tobin
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("k");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("tobin");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15764: out k 8 mul 3 -1 roll putinterval
		var t=this.dstk.get("out");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("k");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f59(){
		//#line 15756: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15757: fnc1first {  % FNC1 as GS
		var t=this.dstk.get("fnc1first");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15760: /out in length 8 mul string def
		this.stk[this.ptr++]="out";
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15761: 0 1 in length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f60(){
		//#line 15773: k in length eq {exit} if
		return -1;
	}
	function $f61(){
		//#line 15775: dup 16#E040 lt {16#8140} {16#C140} ifelse sub
	...
	function $f63(){
		...
		//#line 15774: in k get 256 mul in k 1 add get add
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("k");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		//#line 15776: dup -8 bitshift 16#C0 mul exch 16#00FF and add
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=-8;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 15777: 13 tobin dup out exch m exch putinterval
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15778: length m add /m exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f64(){
		//#line 15770: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15771: /out in length 2 idiv 13 mul string def
		this.stk[this.ptr++]="out";
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	...
	function $f65(){
		//#line 15787: dup bits j 3 -1 roll putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15788: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f66(){
		//#line 15791: /numNs [ msglen {0} repeat 0 ] def
		this.stk[this.ptr++]=0;
	}
	function $f67(){
		//#line 15792: /numAs [ msglen {0} repeat 0 ] def
		this.stk[this.ptr++]=0;
	}
	function $f68(){
		//#line 15793: /numBs [ msglen {0} repeat 0 ] def
		this.stk[this.ptr++]=0;
	}
	function $f69(){
		//#line 15794: /numKs [ msglen {0} repeat -1 ] def
		this.stk[this.ptr++]=0;
	}
	function $f70(){
		//#line 15795: /nextNs [ msglen {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f71(){
		//#line 15796: /nextBs [ msglen {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f72(){
		//#line 15797: /nextAs [ msglen {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f73(){
		//#line 15798: /nextKs [ msglen {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f74(){
		//#line 15803: nextKs i 0 put
		...
		this.ptr-=3;
		//#line 15804: numKs i numKs i 1 add get 1 add put
	...
	function $f75(){
		//#line 15806: nextKs i nextKs i 1 add get 1 add put
		var t=this.dstk.get("nextKs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f76(){
		...
		this.ptr-=3;
		//#line 15810: numNs i numNs i 1 add get 1 add put
	...
	function $f77(){
		//#line 15812: nextNs i nextNs i 1 add get 1 add put
		var t=this.dstk.get("nextNs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f78(){
		...
		this.ptr-=3;
		//#line 15816: numBs i numBs i 1 add get 1 add put
	...
	function $f79(){
		//#line 15818: nextBs i nextBs i 1 add get 1 add put
		var t=this.dstk.get("nextBs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f80(){
		...
		this.ptr-=3;
		//#line 15822: numAs i numAs i 1 add get 1 add put
	...
	function $f81(){
		//#line 15824: nextAs i nextAs i 1 add get 1 add put
		var t=this.dstk.get("nextAs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f82(){
		//#line 15800: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15801: /barchar msg i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15802: Kexcl barchar known {
		...
		//#line 15808: Nexcl barchar known {
		...
		//#line 15814: Bexcl barchar known {
		...
		//#line 15820: Aexcl barchar known {
	...
	function $f83(){
		//#line 15827: /numKs [ numKs {1 add 2 idiv} forall ] def
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	...
	function $f84(){
		//#line 15829: /KbeforeB {numK exch ver get ge nextBs numK 2 mul i add get 0 eq and} bind def
	...
	function $f85(){
		//#line 15830: /KbeforeA {numK exch ver get ge nextAs numK 2 mul i add get 0 eq and} bind def
		var t=this.dstk.get("numK");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f86(){
		//#line 15831: /KbeforeN {numK exch ver get ge nextNs numK 2 mul i add get 0 eq and} bind def
		var t=this.dstk.get("numK");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f87(){
		//#line 15832: /KbeforeE {numK exch ver get ge numK 2 mul i add msglen eq and} bind def
		var t=this.dstk.get("numK");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f88(){
		//#line 15833: /AbeforeK {numA exch ver get ge nextKs numA i add get 0 eq and} bind def
	...
	function $f89(){
		//#line 15834: /AbeforeB {numA exch ver get ge nextBs numA i add get 0 eq and} bind def
		var t=this.dstk.get("numA");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f90(){
		//#line 15835: /AbeforeN {numA exch ver get ge nextNs numA i add get 0 eq and} bind def
		var t=this.dstk.get("numA");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f91(){
		//#line 15836: /AbeforeE {numA exch ver get ge numA i add msglen eq and} bind def
		var t=this.dstk.get("numA");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f92(){
		//#line 15837: /NbeforeK {numN exch ver get ge nextKs numN i add get 0 eq and} bind def
	...
	function $f93(){
		//#line 15838: /NbeforeB {numN exch ver get ge nextBs numN i add get 0 eq and} bind def
		var t=this.dstk.get("numN");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f94(){
		//#line 15839: /NbeforeA {numN exch ver get ge nextAs numN i add get 0 eq and} bind def
		var t=this.dstk.get("numN");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f95(){
		//#line 15840: /NbeforeE {numN exch ver get ge numN i add msglen eq and} bind def
		var t=this.dstk.get("numN");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("ver");
	...
	function $f96(){
		//#line 15851: i msglen ge {exit} if
		return -1;
	}
	function $f97(){
		//#line 15856: ver vM1 eq numA 1 ge and {/seq -1 def exit} if
	...
	function $f98(){
		//#line 15857: ver vM1 eq numB 1 ge and {/seq -1 def exit} if
		this.stk[this.ptr++]="seq";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		return -1;
	...
	function $f99(){
		//#line 15858: ver vM1 eq numK 1 ge and {/seq -1 def exit} if
		this.stk[this.ptr++]="seq";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		return -1;
	...
	function $f100(){
		//#line 15859: ver vM2 eq numB 1 ge and {/seq -1 def exit} if
		this.stk[this.ptr++]="seq";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		return -1;
	...
	function $f101(){
		//#line 15860: ver vM2 eq numK 1 ge and {/seq -1 def exit} if
		this.stk[this.ptr++]="seq";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		return -1;
	...
	function $f102(){
		//#line 15863: [ 1  1  1  e  e  1  1] KbeforeA {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f103(){
		//#line 15864: [ 1  1  1  e  e  1  1] KbeforeN {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f104(){
		//#line 15865: [ 5  5  6  e  e  2  3] KbeforeB {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f105(){
		//#line 15866: [ 1  1  1  e  e  1  1] KbeforeE {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f106(){
		//#line 15867: numK 1 ge {B exit} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f107(){
		//#line 15868: [ 6  7  8  e  e  3  4] AbeforeB {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f108(){
		//#line 15869: [ 1  1  1  e  1  1  1] AbeforeE {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f109(){
		//#line 15871: ver vM1 ne ver vM2 ne and {B} {A} ifelse exit
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f110(){
	...
	function $f112(){
		//#line 15873: [ 4  4  5  e  e  2  3] NbeforeB {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f113(){
		//#line 15874: [ 1  1  1  e  e  1  1] NbeforeB {B exit} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f114(){
		//#line 15875: [ 7  8  9  e  3  4  5] NbeforeA {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f115(){
		//#line 15876: [ 1  1  1  e  1  1  1] NbeforeA {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f116(){
		//#line 15877: numN 1 ge {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	...
	function $f118(){
		//#line 15881: [ 9 12 13  e  e  4  5] KbeforeB {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f119(){
		//#line 15882: [ 9 10 12  e  e  4  5] KbeforeA {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f120(){
		//#line 15883: [ 9 10 11  e  e  5  6] KbeforeN {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f121(){
		//#line 15884: [ 4  5  6  e  e  2  3] KbeforeE {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f122(){
		//#line 15885: [11 12 14  e  e  5  7] AbeforeK {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f123(){
		//#line 15886: [11 15 16  e  e  6  7] AbeforeB {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f124(){
		//#line 15887: [12 13 15  e  e  6  8] AbeforeN {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f125(){
		//#line 15888: [ 6  7  8  e  e  3  4] AbeforeE {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f126(){
		//#line 15889: [ 6  7  8  e  e  3  4] NbeforeK {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f127(){
		//#line 15890: [ 6  8  9  e  e  3  4] NbeforeB {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f128(){
		//#line 15891: [ 6  7  8  e  e  3  4] NbeforeA {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f129(){
		//#line 15892: [ 3  4  5  e  e  2  3] NbeforeE {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	...
	function $f131(){
		//#line 15896: numK 1 ge {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f132(){
		//#line 15897: numB 1 ge {B exit} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f133(){
		//#line 15898: [13 15 17  e  5  7  9] NbeforeA {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f134(){
		//#line 15899: [13 17 18  e  e  7  9] NbeforeB {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f135(){
		//#line 15900: [ 7  8  9  e  3  4  5] NbeforeE {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	...
	function $f137(){
		//#line 15904: numK 1 ge {K exit} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f138(){
		//#line 15905: numB 1 ge {B exit} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f139(){
		//#line 15906: numA 1 ge {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	...
	function $f141(){
		//#line 15910: numB 1 ge {B exit} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f142(){
		//#line 15911: numA 1 ge {A exit} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f143(){
		//#line 15912: numN 1 ge {N exit} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	...
	function $f145(){
		//#line 15862: mode -1 eq {  % Set initial mode
	...
	function $f146(){
		//#line 15916: dup K eq fnc1first and {pop B} if  % No kanji with fnc1first
		this.ptr--;
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f147(){
		//#line 15919: /dat msg i mode K eq {2} {1} ifelse getinterval def
		this.stk[this.ptr++]=2;
	}
	function $f148(){
		//#line 15919: /dat msg i mode K eq {2} {1} ifelse getinterval def
	...
	function $f149(){
		...
		this.ptr--;
		//#line 15922: [ exch aload pop dat aload pop ]
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.stk[this.ptr-1];
		for (var i = 0; i < t.length; i++) this.stk[this.ptr-1+i]=t.get(i);
	...
	function $f150(){
		//#line 15926: mode K eq {K msg i numK 2 mul getinterval} if
		var t=this.dstk.get("K");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f151(){
		//#line 15927: mode B eq {B msg i numB getinterval} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f152(){
		//#line 15928: mode A eq {A msg i numA getinterval} if
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f153(){
		//#line 15929: mode N eq {N msg i numN getinterval} if
		var t=this.dstk.get("N");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f154(){
		...
		//#line 15930: /dat exch def /sw exch def
		this.stk[this.ptr++]="dat";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15931: /seq [ seq aload pop sw dat ] def
		this.stk[this.ptr++]="seq";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("seq");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f155(){
		...
		//#line 15852: /numK numKs i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15853: /numB numBs i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15854: /numA numAs i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15855: /numN numNs i get def
		...
		//#line 15917: dup mode eq {  % Same mode encode directly
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 15933: /i i dat length add def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("dat");
	...
	function $f156(){
		//#line 15938: seq -1 eq {exit} if  % Sequence not available
		return -1;
	}
	function $f157(){
		//#line 15941: fnc1first {(0101) addtobits} if
		this.stk[this.ptr++]=BWIPJS.psstring("0101");
		var t=this.dstk.get("addtobits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f158(){
		//#line 15950: /abort true def exit
	...
	function $f159(){
		//#line 15952: chars length mode K eq {2 idiv} if cclen tobin addtobits
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	}
	function $f160(){
		//#line 15944: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15945: /mode seq i get def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("seq");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15946: mids ver get mode get addtobits
		...
		var t=this.dstk.get("addtobits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15947: /cclen cclens ver get mode get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15948: /chars seq i 1 add get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15949: chars length 2 cclen exp cvi ge {  % Too many characters for cc indicator
		...
		var t=this.dstk.get("addtobits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15953: chars encfuncs mode get load exec addtobits
		var t=this.dstk.get("chars");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f162(){
		...
		//#line 15939: /bits 23648 string def
		...
		//#line 15942: /abort false def
		this.stk[this.ptr++]="abort";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15943: 0 2 seq length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("seq");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15956: /bits bits 0 j getinterval def
		this.stk[this.ptr++]="bits";
		var t=this.dstk.get("bits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15957: msgbits ver bits put
	...
	function $f163(){
		//#line 15847: /ver exch def
		this.stk[this.ptr++]="ver";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15850: /mode -1 def /seq [] def /i 0 def {
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=-1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="seq";
	...
	function $f164(){
		//#line 16026: /ncws ncws 1 add def
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16027: /rbit 0 def
		this.stk[this.ptr++]="rbit";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16028: /lc4b true def
		this.stk[this.ptr++]="lc4b";
		this.stk[this.ptr++]=true;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f165(){
		//#line 16032: /dmod dcws 8 mul lc4b {4} {0} ifelse sub def  % Number of data modules
		this.stk[this.ptr++]=4;
	}
	function $f166(){
		//#line 16032: /dmod dcws 8 mul lc4b {4} {0} ifelse sub def  % Number of data modules
	...
	function $f167(){
		//#line 16036: format (any) ne format frmt ne and {/okay false def} if  % The format must match that supplied
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f168(){
		//#line 16037: frmt (micro) eq fnc1first and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f169(){
		//#line 16038: version (unset) ne version vers ne and {/okay false def} if  % The version must match that supplied
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f170(){
		//#line 16039: ecb1 -1 eq ecb2 -1 eq or {/okay false def} if % Error correction level must be valid
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f171(){
		//#line 16042: /okay false def
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f172(){
		//#line 16044: verbits length dmod gt {/okay false def} if  % and fit into data modules
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	...
	function $f175(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16014: /m metrics i get def
		this.stk[this.ptr++]="m";
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16015: /frmt m 0 get def                             % Format of the symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16016: /vers m 1 get def                             % Version of symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16017: /vergrp m 2 get def                           % Version group
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16018: /size m 3 get def                             % Length of side
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16019: /asp2 m 4 get def                             % Position of second alignment symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16020: /asp3 m 5 get def                             % Position of third alignment symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16021: /nmod m 6 get def                             % Number of modules
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16022: /ncws nmod 8 idiv def                         % Total number of codewords
		this.stk[this.ptr++]="ncws";
		...
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16023: /rbit nmod 8 mod def                          % Number of remainder bits
		this.stk[this.ptr++]="rbit";
		var t=this.dstk.get("nmod");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=8;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16024: /lc4b false def                               % Last data codeword is 4 bits long
		this.stk[this.ptr++]="lc4b";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16025: size 11 eq size 15 eq or {                    % Adjustments for M1 and M3 symbols
		...
		//#line 16030: /ecws m 7 get eclval get def                  % Number of error correction codewords
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16031: /dcws ncws ecws sub def                       % Number of data codewords
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16033: /ecb1 m 8 get eclval 2 mul get def            % First error correction blocks
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16034: /ecb2 m 8 get eclval 2 mul 1 add get def      % Second error correction blocks
		...
		//#line 16040: /verbits msgbits vergrp get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16041: verbits -1 eq {                               % Bitstream must be available
		var t=this.dstk.get("verbits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=-1;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 16046: /term (000000000) 0 termlens vergrp get getinterval def
	...
	function $f176(){
		//#line 16051: /bwipp.qrcodeNoValidSymbol (No valid symbol available) //raiseerror exec
	...
	function $f177(){
		//#line 16061: /term term 0 dmod msgbits length sub term length 2 copy gt {exch} if pop getinterval def
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	}
	function $f178(){
		//#line 16069: 0 1 pad length 1 sub {pad exch 48 put} for
	...
	function $f179(){
		//#line 16073: msgbits length 8 div ceiling 8 mul cvi 8 dmod lc4b {5} {1} ifelse sub {
		this.stk[this.ptr++]=5;
	}
	function $f180(){
		//#line 16073: msgbits length 8 div ceiling 8 mul cvi 8 dmod lc4b {5} {1} ifelse sub {
	...
	function $f181(){
		//#line 16074: pad exch padstrs padnum get putinterval 
		var t=this.dstk.get("pad");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		this.ptr--;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 16075: /padnum padnum 1 add 2 mod def
	...
	function $f182(){
		//#line 16083: lc4b c cws length 1 sub eq and {/bpcw 4 def} if
		this.stk[this.ptr++]="bpcw";
		this.stk[this.ptr++]=4;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f183(){
		//#line 16087: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16088: /cw cw 2 bpcw i sub 1 sub exp cvi cwb i get 48 sub mul add def
	...
	function $f184(){
		//#line 16081: /c exch def
		this.stk[this.ptr++]="c";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16082: /bpcw 8 def
		this.stk[this.ptr++]="bpcw";
		this.stk[this.ptr++]=8;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16083: lc4b c cws length 1 sub eq and {/bpcw 4 def} if
		...
		//#line 16084: /cwb pad c 8 mul bpcw getinterval def
	...
	function $f185(){
		//#line 16094: /rsalog [ 1 255 { dup 2 mul dup 256 ge {285 xor} if } repeat ] def
	...
	function $f187(){
		//#line 16096: 1 1 255 {dup rsalog exch get exch rslog 3 1 roll put} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f188(){
		//#line 16101: rslog exch get exch rslog exch get add 255 mod rsalog exch get
		var t=this.dstk.get("rslog");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f189(){
		//#line 16103: pop pop 0
		this.ptr--;
		this.ptr--;
		this.stk[this.ptr++]=0;
	}
	function $f190(){
		//#line 16100: 2 copy 0 ne exch 0 ne and { 
		this.stk[this.ptr++]=2;
	...
	function $f191(){
		//#line 16108: /coeffs [ 1 ecpb {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f192(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16114: coeffs j coeffs j 1 sub get coeffs j get rsalog i get rsprod xor put
	...
	function $f193(){
		//#line 16110: /i exch def 
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16111: coeffs i 1 add coeffs i get put
		var t=this.dstk.get("coeffs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 16116: coeffs 0 coeffs 0 get rsalog i get rsprod put
		var t=this.dstk.get("coeffs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("coeffs");
	...
	function $f195(){
		//#line 16124: /rscws [ rscws {} forall ecpb {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f196(){
		//#line 16129: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16130: rscws m j add 1 add coeffs ecpb j sub 1 sub get k rsprod rscws m j add 1 add get xor put
	...
	function $f197(){
		//#line 16126: /m exch def
		this.stk[this.ptr++]="m";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16127: /k rscws m get def
		this.stk[this.ptr++]="k";
		var t=this.dstk.get("rscws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("m");
	...
	function $f198(){
		//#line 16122: /rscws exch def
		this.stk[this.ptr++]="rscws";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16123: /rsnd rscws length def
		...
		//#line 16133: rscws rsnd ecpb getinterval
		var t=this.dstk.get("rscws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("rsnd");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f199(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16141: dcwsb i cws i dcpb mul dcpb getinterval put
		...
		this.ptr-=3;
		//#line 16142: ecwsb i dcwsb i get rscodes put
	...
	function $f200(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16146: dcwsb ecb1 i add cws ecb1 dcpb mul i dcpb 1 add mul add dcpb 1 add getinterval put
		var t=this.dstk.get("dcwsb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ecb1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 16147: ecwsb ecb1 i add dcwsb ecb1 i add get rscodes put
		var t=this.dstk.get("ecwsb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ecb1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f201(){
		//#line 16158: cws cw dcwsb j get i get put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("cw");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f202(){
		//#line 16156: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16157: i dcwsb j get length lt {  % Ignore the end of short blocks
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("dcwsb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f203(){
		//#line 16154: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16155: 0 1 ecb1 ecb2 add 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("ecb1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f204(){
		//#line 16166: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16167: cws cw ecwsb j get i get put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("cw");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f205(){
		//#line 16164: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16165: 0 1 ecb1 ecb2 add 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("ecb1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f206(){
		//#line 16174: /pad cws length 1 add array def
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16175: pad 0 cws putinterval
		var t=this.dstk.get("pad");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 16176: pad pad length 1 sub 0 put
		var t=this.dstk.get("pad");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("pad");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f207(){
		//#line 16183: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16184: cws i cws i get 15 and 4 bitshift put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 16185: cws i cws i 1 add get -4 bitshift 15 and cws i get or put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f208(){
		//#line 16182: dcws 1 sub 1 ncws 2 sub {
		var t=this.dstk.get("dcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		...
		//#line 16187: cws ncws 1 sub cws ncws 1 sub get 15 and 4 bitshift put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ncws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f209(){
		//#line 16191: /pixs [ size size mul {-1} repeat ] def
		this.stk[this.ptr++]=-1;
	}
	function $f210(){
		//#line 16192: /qmv {size mul add} bind def
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f211(){
		//#line 16212: pixs size x sub 1 sub y qmv fpb put
		...
		this.ptr-=3;
		//#line 16213: pixs x size y sub 1 sub qmv fpb put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("x");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f212(){
		//#line 16208: /x exch def
		this.stk[this.ptr++]="x";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16209: /fpb fpat y get x get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16210: pixs x y qmv fpb put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("x");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f213(){
		//#line 16206: /y exch def
		this.stk[this.ptr++]="y";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16207: 0 1 fpat 0 get length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("fpat");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f214(){
		//#line 16232: /pa exch def
		this.stk[this.ptr++]="pa";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16233: pixs px pa add py pb add qmv algnpat pb get pa get put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f216(){
		//#line 16227: /py exch def
		this.stk[this.ptr++]="py";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16228: /px exch def
	...
	function $f217(){
		//#line 16238: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16239: i 4 putalgnpat
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
		var t=this.dstk.get("putalgnpat");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 16240: 4 i putalgnpat
		this.stk[this.ptr++]=4;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("putalgnpat");
	...
	function $f218(){
		//#line 16245: /y exch def
		this.stk[this.ptr++]="y";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16246: x y putalgnpat
		var t=this.dstk.get("x");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("y");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f219(){
		//#line 16243: /x exch def
		this.stk[this.ptr++]="x";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16244: asp2 2 sub asp3 asp2 sub size 9 sub {
	...
	function $f220(){
		//#line 16253: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16254: pixs i 6 qmv i 1 add 2 mod put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 16255: pixs 6 i qmv i 1 add 2 mod put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=6;
		var t=this.dstk.get("i");
	...
	function $f222(){
		//#line 16259: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16260: pixs i 0 qmv i 1 add 2 mod put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 16261: pixs 0 i qmv i 1 add 2 mod put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("i");
	...
	function $f224(){
		//#line 16267: /formatmap [
		this.stk[this.ptr++]="formatmap";
		this.stk[this.ptr++]=Infinity;
		//#line 16268: [ [ 0 8 ] [ 8 size 1 sub ] ]  [ [ 1 8 ] [ 8 size 2 sub ] ]  [ [ 2 8 ] [ 8 size 3 sub ] ]
		this.stk[this.ptr++]=Infinity;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16269: [ [ 3 8 ] [ 8 size 4 sub ] ]  [ [ 4 8 ] [ 8 size 5 sub ] ]  [ [ 5 8 ] [ 8 size 6 sub ] ]
		this.stk[this.ptr++]=Infinity;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16270: [ [ 7 8 ] [ 8 size 7 sub ] ]  [ [ 8 8 ] [ size 8 sub 8 ] ]  [ [ 8 7 ] [ size 7 sub 8 ] ]
		this.stk[this.ptr++]=Infinity;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16271: [ [ 8 5 ] [ size 6 sub 8 ] ]  [ [ 8 4 ] [ size 5 sub 8 ] ]  [ [ 8 3 ] [ size 4 sub 8 ] ]
		this.stk[this.ptr++]=Infinity;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16272: [ [ 8 2 ] [ size 3 sub 8 ] ]  [ [ 8 1 ] [ size 2 sub 8 ] ]  [ [ 8 0 ] [ size 1 sub 8 ] ]
		this.stk[this.ptr++]=Infinity;
	...
	function $f225(){
		//#line 16275: /formatmap [
		this.stk[this.ptr++]="formatmap";
		this.stk[this.ptr++]=Infinity;
		//#line 16276: [ [ 1 8 ] ]  [ [ 2 8 ] ]  [ [ 3 8 ] ]  [ [ 4 8 ] ]  [ [ 5 8 ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=BWIPJS.psarray([1,8]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16277: [ [ 6 8 ] ]  [ [ 7 8 ] ]  [ [ 8 8 ] ]  [ [ 8 7 ] ]  [ [ 8 6 ] ]
		this.stk[this.ptr++]=Infinity;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16278: [ [ 8 5 ] ]  [ [ 8 4 ] ]  [ [ 8 3 ] ]  [ [ 8 2 ] ]  [ [ 8 1 ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=BWIPJS.psarray([8,5]);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
	...
	function $f227(){
		//#line 16282: { {} forall qmv pixs exch 0 put } forall
	...
	function $f229(){
		//#line 16287: /versionmap [
		this.stk[this.ptr++]="versionmap";
		this.stk[this.ptr++]=Infinity;
		//#line 16288: [ [ size  9 sub 5 ] [ 5 size  9 sub ] ]  [ [ size 10 sub 5 ] [ 5 size 10 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16289: [ [ size 11 sub 5 ] [ 5 size 11 sub ] ]  [ [ size  9 sub 4 ] [ 4 size  9 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16290: [ [ size 10 sub 4 ] [ 4 size 10 sub ] ]  [ [ size 11 sub 4 ] [ 4 size 11 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16291: [ [ size  9 sub 3 ] [ 3 size  9 sub ] ]  [ [ size 10 sub 3 ] [ 3 size 10 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16292: [ [ size 11 sub 3 ] [ 3 size 11 sub ] ]  [ [ size  9 sub 2 ] [ 2 size  9 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16293: [ [ size 10 sub 2 ] [ 2 size 10 sub ] ]  [ [ size 11 sub 2 ] [ 2 size 11 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16294: [ [ size  9 sub 1 ] [ 1 size  9 sub ] ]  [ [ size 10 sub 1 ] [ 1 size 10 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16295: [ [ size 11 sub 1 ] [ 1 size 11 sub ] ]  [ [ size  9 sub 0 ] [ 0 size  9 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 16296: [ [ size 10 sub 0 ] [ 0 size 10 sub ] ]  [ [ size 11 sub 0 ] [ 0 size 11 sub ] ]
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f232(){
		//#line 16302: { {} forall qmv pixs exch 0 put } forall
	...
	function $f234(){
		//#line 16307: pixs 8 size 8 sub qmv 1 put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=8;
		var t=this.dstk.get("size");
	...
	function $f235(){
		//#line 16313: {add 2 mod} bind
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	}
	function $f236(){
		//#line 16314: {exch pop 2 mod} bind
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	...
	function $f237(){
		//#line 16315: {pop 3 mod} bind
		this.ptr--;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	}
	function $f238(){
		//#line 16316: {add 3 mod} bind
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	}
	function $f239(){
		//#line 16317: {2 idiv exch 3 idiv add 2 mod} bind
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=3;
	...
	function $f240(){
		//#line 16318: {mul dup 2 mod exch 3 mod add} bind
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	...
	function $f241(){
		//#line 16319: {mul dup 2 mod exch 3 mod add 2 mod} bind
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	...
	function $f242(){
		//#line 16320: {2 copy mul 3 mod 3 1 roll add 2 mod add 2 mod} bind
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f245(){
		//#line 16325: {2 idiv exch 3 idiv add 2 mod} bind
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=3;
	...
	function $f246(){
		//#line 16326: {mul dup 2 mod exch 3 mod add 2 mod} bind
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	...
	function $f247(){
		//#line 16327: {2 copy mul 3 mod 3 1 roll add 2 mod add 2 mod} bind
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f248(){
		//#line 16323: /maskfuncs [ 
		this.stk[this.ptr++]="maskfuncs";
		this.stk[this.ptr++]=BWIPJS.psarray([$f244,$f245,$f246,$f247]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f249(){
		//#line 16339: pixs i j qmv get -1 eq and {1} {0} ifelse
		this.stk[this.ptr++]=1;
	}
	function $f250(){
		//#line 16339: pixs i j qmv get -1 eq and {1} {0} ifelse
	...
	function $f251(){
		//#line 16337: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16338: i j maskfuncs m get exec 0 eq 
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 16340: mask i j qmv 3 -1 roll put
	...
	function $f252(){
		//#line 16335: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16336: 0 1 size 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f253(){
		//#line 16332: /m exch def
		this.stk[this.ptr++]="m";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16333: /mask size size mul array def
	...
	function $f254(){
		//#line 16353: posx 0 lt {exit} if
		return -1;
	}
	function $f255(){
		//#line 16355: cws num 8 idiv get 7 num 8 mod sub neg bitshift 1 and
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 16356: pixs posx posy qmv 3 -1 roll put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f256(){
		//#line 16360: /col 0 def
		this.stk[this.ptr++]="col";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16361: /posx posx 1 sub def
	...
	function $f257(){
		//#line 16371: format (full) eq posx 6 eq and {/posx posx 1 sub def} if
		this.stk[this.ptr++]="posx";
		var t=this.dstk.get("posx");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f258(){
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16368: /posy posy dir add def
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16369: /posx posx 2 sub def
		this.stk[this.ptr++]="posx";
		var t=this.dstk.get("posx");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
	...
	function $f259(){
		//#line 16363: /col 1 def
		this.stk[this.ptr++]="col";
		this.stk[this.ptr++]=1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16364: /posx posx 1 add def 
		this.stk[this.ptr++]="posx";
		var t=this.dstk.get("posx");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16365: /posy posy dir add def
		this.stk[this.ptr++]="posy";
		var t=this.dstk.get("posy");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("dir");
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16366: posy 0 lt posy size ge or {  % Turn around at top and bottom
		var t=this.dstk.get("posy");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]<this.stk[this.ptr-1]; this.ptr--;
	...
	function $f260(){
		...
		//#line 16354: pixs posx posy qmv get -1 eq {
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("posx");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f261(){
		//#line 16380: /scr1 0 scrle { dup 5 ge {add 2 sub dup} if pop } forall def
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f263(){
		//#line 16387: scrle j 2 sub 5 getinterval {fact eq} forall and exch pop and and {
	...
	function $f264(){
		//#line 16389: /scr3 scr3 40 add def
	...
	function $f265(){
		//#line 16392: /scr3 scr3 40 add def
		this.stk[this.ptr++]="scr3";
		var t=this.dstk.get("scr3");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=40;
	...
	function $f266(){
		//#line 16391: scrle j 3 sub get 4 ge scrle j 3 add get 4 ge or {
	...
	function $f267(){
		//#line 16388: j 3 eq j 4 add scrle length ge or {  % At either extent of run
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 16390: } {  % Bounded by dark modules
	...
	function $f268(){
		//#line 16386: /fact scrle j get 3 idiv def
	...
	function $f269(){
		//#line 16384: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16385: scrle j get 3 mod 0 eq {  % Multiple of 3 black modules
		var t=this.dstk.get("scrle");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f270(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16382: /scr3 0 def
		this.stk[this.ptr++]="scr3";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16383: 3 2 scrle length 3 sub {  % Scan odd (dark) runs within bounds
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("scrle");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f271(){
		//#line 16416: sym exch get exch 1 index eq {exch 1 add exch} {1 exch} ifelse
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f274(){
		//#line 16427: exch 1 index eq {exch 1 add exch} {1 exch} ifelse
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f277(){
		//#line 16436: symrow 0 get 1 eq {0} {1} ifelse
		this.stk[this.ptr++]=0;
	}
	function $f278(){
		//#line 16436: symrow 0 get 1 eq {0} {1} ifelse
	...
	function $f279(){
		//#line 16437: symrow {exch 1 index add exch} forall
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=1;
		if (this.stk[this.ptr-1] >= this.ptr) throw "index: underflow";
		this.stk[this.ptr-1]=this.stk[this.ptr-2-this.stk[this.ptr-1]];
	...
	function $f280(){
		//#line 16443: n2 size { exch sizeadd1 index add 3 and 0 eq {3 add} if } repeat
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f281(){
	...
	function $f282(){
		//#line 16441: mark
		this.stk[this.ptr++]=Infinity;
		//#line 16442: lastpairs aload pop thispairs aload pop
		...
		//#line 16444: /n2 exch def
		this.stk[this.ptr++]="n2";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16445: cleartomark
		for (var i=this.ptr-1; i>=0 && this.stk[i]!==Infinity; i--);
		if (i==-1) throw "cleartomark: underflow";
		this.ptr=i;
	}
	function $f283(){
		//#line 16411: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16414: mark 0 0
		...
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=0;
		//#line 16415: i size dup dup mul 1 sub {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 16418: pop
		this.ptr--;
		//#line 16419: rle 0 counttomark 2 sub getinterval astore
		...
		t.assign(0,a);
		this.ptr-=t.length;
		//#line 16420: evalfulln1n3 n3 add /n3 exch def n1 add /n1 exch def
		...
		//#line 16421: pop
		this.ptr--;
		//#line 16424: /symrow sym i size mul size getinterval def
		...
		//#line 16429: pop
		this.ptr--;
		//#line 16430: rle 0 counttomark 2 sub getinterval astore
		var t=this.dstk.get("rle");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		for (var i=this.ptr-1; i>=0 && this.stk[i]!==Infinity; i--);
		...
		t.assign(0,a);
		this.ptr-=t.length;
		//#line 16431: evalfulln1n3 n3 add /n3 exch def n1 add /n1 exch def
		var t=this.dstk.get("evalfulln1n3");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("n3");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 16432: pop
		this.ptr--;
		//#line 16435: /lastpairs thispairs /thispairs lastpairs def def
		...
		//#line 16438: pop
		this.ptr--;
		//#line 16439: thispairs astore pop
		var t=this.dstk.get("thispairs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-1];
		if (t.length >= this.ptr) throw "astore: underflow";
	...
	function $f284(){
		//#line 16451: /dark 0 sym {add} forall def
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f285(){
		//#line 16403: /sym exch def
		this.stk[this.ptr++]="sym";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16405: /n1 0 def /n2 0 def /n3 0 def
		this.stk[this.ptr++]="n1";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="n2";
		...
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16406: /rle size 1 add array def
		...
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16407: /lastpairs size array def
		this.stk[this.ptr++]="lastpairs";
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16408: /thispairs size array def
		this.stk[this.ptr++]="thispairs";
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16409: /sizeadd1 size 1 add def
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16452: /n4 dark 100 mul size dup mul div 50 sub abs 5 div cvi 10 mul def
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16454: n1 n2 add n3 add n4 add
		var t=this.dstk.get("n1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("n2");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f286(){
		//#line 16462: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16463: /dkrhs dkrhs sym size 1 sub i qmv get add def
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16464: /dkbot dkbot sym i size 1 sub qmv get add def
	...
	function $f287(){
		//#line 16467: dkrhs 16 mul dkbot add neg
		var t=this.dstk.get("dkrhs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=16;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	...
	function $f288(){
		//#line 16469: dkbot 16 mul dkrhs add neg
		var t=this.dstk.get("dkbot");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=16;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	...
	function $f289(){
		//#line 16459: /sym exch def
		this.stk[this.ptr++]="sym";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16460: /dkrhs 0 def /dkbot 0 def
		this.stk[this.ptr++]="dkrhs";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="dkbot";
	...
	function $f290(){
		//#line 16479: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16480: masksym i pixs i get masks m get i get xor put
	...
	function $f291(){
		//#line 16483: masksym evalfull /score exch def
		var t=this.dstk.get("masksym");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f292(){
		//#line 16485: masksym evalmicro /score exch def
		var t=this.dstk.get("masksym");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f293(){
		//#line 16488: /bestsym masksym def
		this.stk[this.ptr++]="bestsym";
		var t=this.dstk.get("masksym");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16489: /bestmaskval m def
		this.stk[this.ptr++]="bestmaskval";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16490: /bestscore score def
	...
	function $f294(){
		//#line 16476: /m exch def
		this.stk[this.ptr++]="m";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16477: /masksym size size mul array def
		...
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16478: 0 1 size size mul 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("size");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f295(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16503: /ecid (MLHQ) eclevel search pop length exch pop exch pop def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16504: /fmtval fmtvals ecid 3 bitshift bestmaskval add get def
	...
	function $f296(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16512: /symid [ [0] [1 2] [3 4] [5 6 7] ] size 11 sub 2 idiv get eclval get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16513: /fmtval fmtvals symid 2 bitshift bestmaskval add get def
		this.stk[this.ptr++]="fmtval";
		var t=this.dstk.get("fmtvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f298(){
		//#line 16518: pixs exch {} forall qmv fmtval 14 i sub neg bitshift 1 and put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f299(){
		//#line 16516: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16517: formatmap i get {
	...
	function $f301(){
		//#line 16535: pixs exch {} forall qmv verval 17 i sub neg bitshift 1 and put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f302(){
		//#line 16533: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16534: versionmap i get {
	...
	function $f303(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16531: /verval vervals size 17 sub 4 idiv 7 sub get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16532: 0 1 versionmap length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("versionmap");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15568: /format (full) def     % full or micro or any
	this.stk[this.ptr++]="format";
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15569: /version (unset) def   % 1-40 or M1-M4
	this.stk[this.ptr++]="version";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15570: /eclevel (unset) def   % L, M, Q or H
	this.stk[this.ptr++]="eclevel";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15571: /parse false def
	this.stk[this.ptr++]="parse";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15572: /parsefnc false def
	this.stk[this.ptr++]="parsefnc";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15575: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 15606: /barlen barcode length def
	...
	this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15613: /msg barlen array def
	this.stk[this.ptr++]="msg";
	var t=this.dstk.get("barlen");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15614: /i 0 def /j 0 def {
	this.stk[this.ptr++]="i";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="j";
	...
	//#line 15629: /msg msg 0 j getinterval def
	this.stk[this.ptr++]="msg";
	var t=this.dstk.get("msg");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15630: /msglen msg length def
	this.stk[this.ptr++]="msglen";
	var t=this.dstk.get("msg");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15633: /fnc1first false def
	this.stk[this.ptr++]="fnc1first";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15634: msglen 0 gt {
	var t=this.dstk.get("msglen");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]>this.stk[this.ptr-1]; this.ptr--;
	...
	//#line 15646: /N 0 def  /A 1 def  /B 2 def  /K 3 def
	this.stk[this.ptr++]="N";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="A";
	...
	//#line 15655: [
	this.stk[this.ptr++]=Infinity;
	//#line 15656: 16#20 16#24 16#25 16#2A 16#2B 16#2D 16#2E 16#2F 16#3A
	...
	//#line 15664: 16#21 16#22 16#23 16#26 16#27 16#28 16#29 16#2C
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15698: /termlens [ 4 4 4 3 5 7 9 ] def
	...
	//#line 15782: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15784: /encfuncs [ /encN /encA /encB /encK ] def
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15843: /msgbits [-1 -1 -1 -1 -1 -1 -1] def
	this.stk[this.ptr++]="msgbits";
	this.stk[this.ptr++]=BWIPJS.psarray([-1,-1,-1,-1,-1,-1,-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15844: /v1to9 0 def  /v10to26 1 def  /v27to40 2 def  /vM1 3 def  /vM2 4 def  /vM3 5 def  /vM4 6 def
	...
	this.stk[this.ptr++]=6;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15845: /e 10000 def
	this.stk[this.ptr++]="e";
	this.stk[this.ptr++]=10000;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15846: [v1to9 v10to26 v27to40 vM1 vM2 vM3 vM4] {
	this.stk[this.ptr++]=Infinity;
	...
	this.stk[this.ptr++]=Infinity;
	//#line 15966: [ (micro)  (M1)  vM1       11  98 99     36  [   2   99   99   99 ]  [  1  0 -1 -1 -1 -1 -1 -1 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("micro");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15967: [ (micro)  (M2)  vM2       13  98 99     80  [   5    6   99   99 ]  [  1  0  1  0 -1 -1 -1 -1 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("micro");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15968: [ (micro)  (M3)  vM3       15  98 99    132  [   6    8   99   99 ]  [  1  0  1  0 -1 -1 -1 -1 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("micro");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15969: [ (micro)  (M4)  vM4       17  98 99    192  [   8   10   14   99 ]  [  1  0  1  0  1  0 -1 -1 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("micro");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15970: [ (full)   (1)   v1to9     21  98 99    208  [   7   10   13   17 ]  [  1  0  1  0  1  0  1  0 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15971: [ (full)   (2)   v1to9     25  18 99    359  [  10   16   22   28 ]  [  1  0  1  0  1  0  1  0 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15972: [ (full)   (3)   v1to9     29  22 99    567  [  15   26   36   44 ]  [  1  0  1  0  2  0  2  0 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15973: [ (full)   (4)   v1to9     33  26 99    807  [  20   36   52   64 ]  [  1  0  2  0  2  0  4  0 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15974: [ (full)   (5)   v1to9     37  30 99   1079  [  26   48   72   88 ]  [  1  0  2  0  2  2  2  2 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15975: [ (full)   (6)   v1to9     41  34 99   1383  [  36   64   96  112 ]  [  2  0  4  0  4  0  4  0 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15976: [ (full)   (7)   v1to9     45  22 38   1568  [  40   72  108  130 ]  [  2  0  4  0  2  4  4  1 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15977: [ (full)   (8)   v1to9     49  24 42   1936  [  48   88  132  156 ]  [  2  0  2  2  4  2  4  2 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15978: [ (full)   (9)   v1to9     53  26 46   2336  [  60  110  160  192 ]  [  2  0  3  2  4  4  4  4 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15979: [ (full)   (10)  v10to26   57  28 50   2768  [  72  130  192  224 ]  [  2  2  4  1  6  2  6  2 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15980: [ (full)   (11)  v10to26   61  30 54   3232  [  80  150  224  264 ]  [  4  0  1  4  4  4  3  8 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15981: [ (full)   (12)  v10to26   65  32 58   3728  [  96  176  260  308 ]  [  2  2  6  2  4  6  7  4 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15982: [ (full)   (13)  v10to26   69  34 62   4256  [ 104  198  288  352 ]  [  4  0  8  1  8  4 12  4 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15983: [ (full)   (14)  v10to26   73  26 46   4651  [ 120  216  320  384 ]  [  3  1  4  5 11  5 11  5 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15984: [ (full)   (15)  v10to26   77  26 48   5243  [ 132  240  360  432 ]  [  5  1  5  5  5  7 11  7 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15985: [ (full)   (16)  v10to26   81  26 50   5867  [ 144  280  408  480 ]  [  5  1  7  3 15  2  3 13 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15986: [ (full)   (17)  v10to26   85  30 54   6523  [ 168  308  448  532 ]  [  1  5 10  1  1 15  2 17 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15987: [ (full)   (18)  v10to26   89  30 56   7211  [ 180  338  504  588 ]  [  5  1  9  4 17  1  2 19 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15988: [ (full)   (19)  v10to26   93  30 58   7931  [ 196  364  546  650 ]  [  3  4  3 11 17  4  9 16 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15989: [ (full)   (20)  v10to26   97  34 62   8683  [ 224  416  600  700 ]  [  3  5  3 13 15  5 15 10 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15990: [ (full)   (21)  v10to26  101  28 50   9252  [ 224  442  644  750 ]  [  4  4 17  0 17  6 19  6 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15991: [ (full)   (22)  v10to26  105  26 50  10068  [ 252  476  690  816 ]  [  2  7 17  0  7 16 34  0 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15992: [ (full)   (23)  v10to26  109  30 54  10916  [ 270  504  750  900 ]  [  4  5  4 14 11 14 16 14 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15993: [ (full)   (24)  v10to26  113  28 54  11796  [ 300  560  810  960 ]  [  6  4  6 14 11 16 30  2 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15994: [ (full)   (25)  v10to26  117  32 58  12708  [ 312  588  870 1050 ]  [  8  4  8 13  7 22 22 13 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15995: [ (full)   (26)  v10to26  121  30 58  13652  [ 336  644  952 1110 ]  [ 10  2 19  4 28  6 33  4 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15996: [ (full)   (27)  v27to40  125  34 62  14628  [ 360  700 1020 1200 ]  [  8  4 22  3  8 26 12 28 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15997: [ (full)   (28)  v27to40  129  26 50  15371  [ 390  728 1050 1260 ]  [  3 10  3 23  4 31 11 31 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15998: [ (full)   (29)  v27to40  133  30 54  16411  [ 420  784 1140 1350 ]  [  7  7 21  7  1 37 19 26 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 15999: [ (full)   (30)  v27to40  137  26 52  17483  [ 450  812 1200 1440 ]  [  5 10 19 10 15 25 23 25 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16000: [ (full)   (31)  v27to40  141  30 56  18587  [ 480  868 1290 1530 ]  [ 13  3  2 29 42  1 23 28 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16001: [ (full)   (32)  v27to40  145  34 60  19723  [ 510  924 1350 1620 ]  [ 17  0 10 23 10 35 19 35 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16002: [ (full)   (33)  v27to40  149  30 58  20891  [ 540  980 1440 1710 ]  [ 17  1 14 21 29 19 11 46 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16003: [ (full)   (34)  v27to40  153  34 62  22091  [ 570 1036 1530 1800 ]  [ 13  6 14 23 44  7 59  1 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16004: [ (full)   (35)  v27to40  157  30 54  23008  [ 570 1064 1590 1890 ]  [ 12  7 12 26 39 14 22 41 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16005: [ (full)   (36)  v27to40  161  24 50  24272  [ 600 1120 1680 1980 ]  [  6 14  6 34 46 10  2 64 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16006: [ (full)   (37)  v27to40  165  28 54  25568  [ 630 1204 1770 2100 ]  [ 17  4 29 14 49 10 24 46 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16007: [ (full)   (38)  v27to40  169  32 58  26896  [ 660 1260 1860 2220 ]  [  4 18 13 32 48 14 42 32 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16008: [ (full)   (39)  v27to40  173  26 54  28256  [ 720 1316 1950 2310 ]  [ 20  4 40  7 43 22 10 67 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 16009: [ (full)   (40)  v27to40  177  30 58  29648  [ 750 1372 2040 2430 ]  [ 19  6 18 31 34 34 20 61 ] ]
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16011: /eclval (LMQH) eclevel search pop length exch pop exch pop def
	...
	//#line 16054: /format frmt def
	this.stk[this.ptr++]="format";
	var t=this.dstk.get("frmt");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16055: /version vers def
	this.stk[this.ptr++]="version";
	var t=this.dstk.get("vers");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16056: /msgbits verbits def
	this.stk[this.ptr++]="msgbits";
	var t=this.dstk.get("verbits");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16057: /dcpb dcws ecb1 ecb2 add idiv def                 % Base data codewords per block
	...
	this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16058: /ecpb ncws ecb1 ecb2 add idiv dcpb sub def        % Error correction codewords per block
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16062: msgbits length term length add string
	var t=this.dstk.get("msgbits");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
	//#line 16063: dup 0 msgbits putinterval
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	this.stk[this.ptr++]=0;
	var t=this.dstk.get("msgbits");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 16064: dup msgbits length term putinterval
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	var t=this.dstk.get("msgbits");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 16065: /msgbits exch def
	this.stk[this.ptr++]="msgbits";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16068: /pad dmod string def
	this.stk[this.ptr++]="pad";
	var t=this.dstk.get("dmod");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
	...
	//#line 16070: pad 0 msgbits putinterval
	var t=this.dstk.get("pad");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	var t=this.dstk.get("msgbits");
	...
	//#line 16079: /cws dcws array def 
	this.stk[this.ptr++]="cws";
	var t=this.dstk.get("dcws");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16080: 0 1 cws length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("cws");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16095: /rslog 256 array def
	...
	//#line 16118: /coeffs coeffs 0 coeffs length 1 sub getinterval def
	this.stk[this.ptr++]="coeffs";
	var t=this.dstk.get("coeffs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	//#line 16134: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16137: /dcwsb ecb1 ecb2 add array def
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16138: /ecwsb ecb1 ecb2 add array def
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16139: 0 1 ecb1 1 sub {  % First group of blocks has smaller number of data codewords
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("ecb1");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16144: 0 1 ecb2 1 sub {  % Second group of blocks has larger number of data codewords
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("ecb2");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16153: 0 1 dcpb {  % Interleave the data codeword blocks
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("dcpb");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16163: 0 1 ecpb 1 sub {  % Interleave the error codeword blocks
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("ecpb");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=Infinity;
	//#line 16196: [ 1 1 1 1 1 1 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,1,1,1,1,1,1,0]);
	//#line 16197: [ 1 0 0 0 0 0 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,0,0,0,0,0,1,0]);
	//#line 16198: [ 1 0 1 1 1 0 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,0,1,1,1,0,1,0]);
	//#line 16199: [ 1 0 1 1 1 0 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,0,1,1,1,0,1,0]);
	//#line 16200: [ 1 0 1 1 1 0 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,0,1,1,1,0,1,0]);
	//#line 16201: [ 1 0 0 0 0 0 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,0,0,0,0,0,1,0]);
	//#line 16202: [ 1 1 1 1 1 1 1 0 ]
	this.stk[this.ptr++]=BWIPJS.psarray([1,1,1,1,1,1,1,0]);
	//#line 16203: [ 0 0 0 0 0 0 0 0 ]
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16205: 0 1 fpat length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("fpat");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16226: /putalgnpat {
	this.stk[this.ptr++]="putalgnpat";
	this.stk[this.ptr++]=$f216;
	//#line 16236: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16237: asp2 2 sub asp3 asp2 sub size 13 sub {
	var t=this.dstk.get("asp2");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	//#line 16242: asp2 2 sub asp3 asp2 sub size 9 sub { 
	var t=this.dstk.get("asp2");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	//#line 16330: /masks maskfuncs length array def
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16331: 0 1 masks length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("masks");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16347: /posx size 1 sub def
	this.stk[this.ptr++]="posx";
	var t=this.dstk.get("size");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=1;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16348: /posy size 1 sub def
	this.stk[this.ptr++]="posy";
	var t=this.dstk.get("size");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=1;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16349: /dir -1 def  % -1 is upwards, 1 is downwards
	this.stk[this.ptr++]="dir";
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16350: /col 1 def   % 0 is left bit, 1 is right bit
	this.stk[this.ptr++]="col";
	this.stk[this.ptr++]=1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16351: /num 0 def
	this.stk[this.ptr++]="num";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16352: { % loop
	...
	//#line 16455: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16458: /evalmicro {
	this.stk[this.ptr++]="evalmicro";
	this.stk[this.ptr++]=$f289;
	//#line 16471: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16474: /bestscore 999999999 def
	this.stk[this.ptr++]="bestscore";
	this.stk[this.ptr++]=999999999;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16475: 0 1 masks length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("masks");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16493: /pixs bestsym def
	this.stk[this.ptr++]="pixs";
	var t=this.dstk.get("bestsym");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16496: format (full) eq {
	var t=this.dstk.get("format");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=BWIPJS.psstring("full");
	if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	//#line 16515: 0 1 formatmap length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("formatmap");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16541: <<
	this.stk[this.ptr++]=Infinity;
	//#line 16542: /ren //renmatrix
	this.stk[this.ptr++]="ren";
	var t=this.dstk.get("renmatrix");
	this.stk[this.ptr++]=t;
	//#line 16543: /pixs pixs
	this.stk[this.ptr++]="pixs";
	var t=this.dstk.get("pixs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 16544: /pixx size
	this.stk[this.ptr++]="pixx";
	var t=this.dstk.get("size");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 16545: /pixy size
	this.stk[this.ptr++]="pixy";
	var t=this.dstk.get("size");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 16546: /height size 2 mul 72 div
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16547: /width size 2 mul 72 div
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 16551: dontdraw not //renmatrix if
