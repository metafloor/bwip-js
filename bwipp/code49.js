...
BWIPJS.bwipp["code49"]=function() {
	...
	function $f25(){
		...
		if (t31 < 0) t=this.stk.splice(this.ptr-t30, -t31);
		else t=this.stk.splice(this.ptr-t30, t30-t31);
	...
	function $f68(){
		...
		if (t105 < 0) t=this.stk.splice(this.ptr-t104, -t105);
		else t=this.stk.splice(this.ptr-t104, t104-t105);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	}
	function $f69(){
	...
	function $f80(){
		...
		if (t134 < 0) t=this.stk.splice(this.ptr-t133, -t134);
		else t=this.stk.splice(this.ptr-t133, t133-t134);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
		this.ptr-=3;
	}
	...
	if (t108 < 0) t=this.stk.splice(this.ptr-t107, -t108);
	else t=this.stk.splice(this.ptr-t107, t107-t108);
	this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	this.xget("cr7");
	this.xget("weightx");
	...
	if (t110 < 0) t=this.stk.splice(this.ptr-t109, -t110);
	else t=this.stk.splice(this.ptr-t109, t109-t110);
	this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	this.xget("ccs");
	this.xget("ccs");
	...
	this.forall(this.stk[--this.ptr],t111);
	this.stk[this.ptr++]=49;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	this.xget("ccs");
	this.xget("ccs");
