...
BWIPJS.bwipp["datamatrix"]=function() {
	...
	function $f0(){
		//#line 14678: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 14679: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 14681: currentdict end /options exch def
	...
	function $f5(){
		//#line 14683: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 14695: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		//#line 14696: length j add 1 add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 14697: pop
		this.ptr--;
		//#line 14698: dup 0 3 getinterval cvi msg exch j 1 sub exch put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		...
		this.ptr-=3;
		//#line 14699: dup length 3 sub 3 exch getinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=3;
	...
	function $f7(){
		//#line 14701: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 14702: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14703: /barcode msg 0 j getinterval def
	...
	function $f9(){
		//#line 14690: /msg barcode length string def
	...
	function $f10(){
		//#line 14721: i barlen eq {exit} if
		return -1;
	}
	function $f11(){
		//#line 14725: /char fncvals barcode i 1 add 4 getinterval get def
	...
	function $f13(){
		//#line 14724: barcode i 1 add get 94 ne {
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f14(){
		...
		//#line 14722: /char barcode i get def
		this.stk[this.ptr++]="char";
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14723: parsefnc char 94 eq and i barlen 4 sub lt and {
	...
	function $f15(){
		//#line 14791: urows 0 ne urows rows ne and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f16(){
		//#line 14792: ucols 0 ne ucols cols ne and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f17(){
		//#line 14793: urows 0 eq ucols 0 eq or rows cols ne and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f18(){
		//#line 14794: okay {/fullcws [ fullcws aload pop ncws ] def} if
	...
	function $f19(){
		//#line 14780: /m exch def
		this.stk[this.ptr++]="m";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14781: /rows m 0 get def                          % Rows in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14782: /cols m 1 get def                          % Columns in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14783: /regh m 2 get def                          % Horizontal regions
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14784: /regv m 3 get def                          % Vertical regions
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14785: /rscw m 4 get def                          % Error correction codewords
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14786: /rsbl m 5 get def                          % Error correction blocks
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14787: /mrows rows 2 regh mul sub def             % Rows in the mapping matrix
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14788: /mcols cols 2 regv mul sub def             % Columns in the mapping matrix
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14789: /ncws mrows mcols mul 8 idiv rscw sub def  % Data codewords
	...
	function $f20(){
		//#line 14796: /numremcws [ 1558 {10000} repeat ] def
		this.stk[this.ptr++]=10000;
	}
	function $f21(){
		//#line 14797: fullcws {numremcws exch 1 sub 1 put} forall
	...
	function $f22(){
		//#line 14801: numremcws i numremcws i 1 add get 1 add put
		var t=this.dstk.get("numremcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f23(){
		//#line 14799: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14800: numremcws i get 1 ne {
		var t=this.dstk.get("numremcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f24(){
		//#line 14811: 0 1 128 {dup 1 add} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f25(){
		//#line 14814: dup 10 2 string cvrs (00) 2 string copy dup 2 3 index length sub 4 -1 roll putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 14815: exch 130 add
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=130;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f26(){
		//#line 14817: 229 [ lC lB fnc1 sapp prog usft m05 m06 lX lT lE eci ] {exch 1 add dup} forall pop
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f28(){
		//#line 14828: 48 1 57 {dup 44 sub} for  % 0-9
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=44;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f29(){
		//#line 14829: 65 1 90 {dup 51 sub} for  % A-Z
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=51;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f30(){
		//#line 14831: /C1vals << 0 1 31 {dup} for >> def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	}
	function $f31(){
		//#line 14833: 33 1 47 {dup 33 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=33;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f32(){
		//#line 14834: 58 1 64 {dup 43 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=43;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f33(){
		//#line 14835: 91 1 95 {dup 69 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=69;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f34(){
		//#line 14839: /C3vals << 96 1 127 {dup 96 sub} for >> def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=96;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f35(){
		//#line 14841: CNvals {[exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
	...
	function $f36(){
		//#line 14842: C1vals {[exch CNvals sft1 get exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f37(){
		//#line 14843: C2vals {[exch CNvals sft2 get exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("CNvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f38(){
		//#line 14844: C3vals {[exch CNvals sft3 get exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("CNvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f39(){
		//#line 14852: 48 1  57 {dup 44 sub} for  % 0-9
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=44;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f40(){
		//#line 14853: 97 1 122 {dup 83 sub} for  % a-z
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=83;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f41(){
		//#line 14855: /T1vals << 0 1 31 {dup} for >> def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	}
	function $f42(){
		//#line 14857: 33 1 47 {dup 33 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=33;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f43(){
		//#line 14858: 58 1 64 {dup 43 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=43;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f44(){
		//#line 14859: 91 1 95 {dup 69 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=69;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f45(){
		//#line 14865: 65 1  90 {dup 64 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=64;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f46(){
		//#line 14866: 123 1 127 {dup 96 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=96;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f47(){
		//#line 14869: TNvals {[exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
	...
	function $f48(){
		//#line 14870: T1vals {[exch TNvals sft1 get exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f49(){
		//#line 14871: T2vals {[exch TNvals sft2 get exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("TNvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f50(){
		//#line 14872: T3vals {[exch TNvals sft3 get exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("TNvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f51(){
		//#line 14877: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14878: Avals i [ Avals usft get aload pop Avals i 128 sub get aload pop ] put
		...
		this.ptr-=3;
		//#line 14879: Cvals i [ Cvals usft get aload pop Cvals i 128 sub get aload pop ] put
		...
		this.ptr-=3;
		//#line 14880: Tvals i [ Tvals usft get aload pop Tvals i 128 sub get aload pop ] put
	...
	function $f52(){
		//#line 14888: 48 1 57 {dup 44 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=44;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f53(){
		//#line 14889: 65 1 90 {dup 51 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=51;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f54(){
		//#line 14892: Xvals {[exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
	...
	function $f55(){
		//#line 14896: 64 1 94 {dup 64 sub} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=64;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f56(){
		//#line 14898: 32 1 63 {dup} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	}
	function $f57(){
		//#line 14901: Evals {[exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
	...
	function $f58(){
		//#line 14905: 0 1 255 {dup} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	}
	function $f59(){
		//#line 14908: Bvals {[exch]} forall
		this.stk[this.ptr++]=Infinity;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
	...
	function $f60(){
		//#line 14913: /numD [ msglen {0} repeat 0 ] def
		this.stk[this.ptr++]=0;
	}
	function $f61(){
		//#line 14914: /nextXterm [ msglen {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f62(){
		//#line 14915: /nextNonX  [ msglen {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f63(){
		//#line 14920: numD i numD i 1 add get 1 add put
	...
	function $f65(){
		//#line 14925: nextXterm i nextXterm i 1 add get 1 add put
		var t=this.dstk.get("nextXterm");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f67(){
		//#line 14930: nextNonX i nextNonX i 1 add get 1 add put
		var t=this.dstk.get("nextNonX");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f68(){
		//#line 14917: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14918: /barchar msg i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 14919: barchar 48 ge barchar 57 le and {
		...
		//#line 14922: barchar 13 eq barchar 42 eq or barchar 62 eq or {
		var t=this.dstk.get("barchar");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 14927: Xvals barchar known not {
	...
	function $f69(){
		//#line 14933: /nextXterm [nextXterm {dup 10000 gt {pop 10000} if} forall] def
		this.ptr--;
		this.stk[this.ptr++]=10000;
	}
	function $f70(){
	...
	function $f71(){
		//#line 14934: /nextNonX  [nextNonX  {dup 10000 gt {pop 10000} if} forall] def
		this.ptr--;
		this.stk[this.ptr++]=10000;
	}
	function $f72(){
	...
	function $f73(){
		//#line 14936: /isD  {char 48 ge char 57 le and} bind def
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]>=this.stk[this.ptr-1]; this.ptr--;
	...
	function $f74(){
		//#line 14937: /isC  {CNvals char known} bind def
		var t=this.dstk.get("CNvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f75(){
		//#line 14938: /isT  {TNvals char known} bind def
		var t=this.dstk.get("TNvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f76(){
		//#line 14939: /isX  {Xvals char known} bind def
		var t=this.dstk.get("Xvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f77(){
		//#line 14940: /isE  {Evals char known} bind def
	...
	function $f78(){
		//#line 14941: /isEA {char 127 gt} bind def
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f79(){
		//#line 14942: /isFN {char 0 lt} bind def
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]<this.stk[this.ptr-1]; this.ptr--;
	...
	function $f80(){
		//#line 14943: /XtermFirst {dup nextXterm exch get exch nextNonX exch get lt} bind def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("nextXterm");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f81(){
		//#line 14949: mode A eq {/ac 0 def /cc 1 def /tc 1 def /xc 1 def /ec 1 def /bc 1.25 def} if
	...
	function $f82(){
		//#line 14950: mode C eq {/cc 0 def} if
		this.stk[this.ptr++]="cc";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f83(){
		//#line 14951: mode T eq {/tc 0 def} if
		this.stk[this.ptr++]="tc";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f84(){
		//#line 14952: mode X eq {/xc 0 def} if
		this.stk[this.ptr++]="xc";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f85(){
		//#line 14953: mode E eq {/ec 0 def} if
		this.stk[this.ptr++]="ec";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f86(){
		//#line 14954: mode B eq {/bc 0 def} if
		this.stk[this.ptr++]="bc";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f87(){
		//#line 14958: [/ac /cc /tc /xc /ec /bc] {dup load ceiling def} forall
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f88(){
		//#line 14959: true [   cc tc xc ec bc] {ac exch le and} forall {A exit} if
	...
	function $f90(){
		//#line 14960: true [ac cc tc xc ec   ] {bc exch lt and} forall {B exit} if
	...
	function $f92(){
		//#line 14961: true [ac cc tc xc    bc] {ec exch lt and} forall {E exit} if
	...
	function $f94(){
		//#line 14962: true [ac cc    xc ec bc] {tc exch lt and} forall {T exit} if
	...
	function $f96(){
		//#line 14963: true [ac cc tc    ec bc] {xc exch lt and} forall {X exit} if
	...
	function $f99(){
		//#line 14967: /ac ac isD {1 2 div add} {isEA {ceiling 2 add} {1 add       } ifelse} ifelse def
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f103(){
		//#line 14968: /cc cc isC {2 3 div add} {isEA { 8 3 div add } { 4 3 div add} ifelse} ifelse def
		this.stk[this.ptr++]=2;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f107(){
		//#line 14969: /tc tc isT {2 3 div add} {isEA { 8 3 div add } { 4 3 div add} ifelse} ifelse def
		this.stk[this.ptr++]=2;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f111(){
		//#line 14970: /xc xc isX {2 3 div add} {isEA {13 3 div add } {10 3 div add} ifelse} ifelse def
		this.stk[this.ptr++]=2;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f115(){
		//#line 14971: /ec ec isE {3 4 div add} {isEA {17 4 div add } {13 4 div add} ifelse} ifelse def
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f119(){
		//#line 14972: /bc bc isFN {4 add} {1 add} ifelse def
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f120(){
	...
	function $f121(){
		//#line 14974: true [   cc tc xc ec bc] {ac 1 add exch le and} forall {A exit} if
		var t=this.dstk.get("ac");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f123(){
		//#line 14975: bc 1 add ac le {B exit} if
		var t=this.dstk.get("B");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f124(){
		//#line 14976: true [   cc tc xc ec   ] {bc 1 add exch lt and} forall {B exit} if
		var t=this.dstk.get("bc");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f126(){
		//#line 14977: true [ac cc tc xc    bc] {ec 1 add exch lt and} forall {E exit} if
		var t=this.dstk.get("ec");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f128(){
		//#line 14978: true [ac cc    xc ec bc] {tc 1 add exch lt and} forall {T exit} if
		var t=this.dstk.get("tc");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f130(){
		//#line 14979: true [ac cc tc    ec bc] {xc 1 add exch lt and} forall {X exit} if
		var t=this.dstk.get("xc");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f132(){
		//#line 14980: true [ac    tc    ec bc] {cc 1 add exch lt and} forall {
		var t=this.dstk.get("cc");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f133(){
		//#line 14981: cc xc lt {C exit} if
		var t=this.dstk.get("C");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	function $f134(){
		//#line 14982: cc xc eq {i k add 1 add XtermFirst {X exit} {C exit} ifelse} if
		var t=this.dstk.get("X");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		return -1;
	}
	...
	function $f139(){
		...
		//#line 14966: /char msg i k add get def
		this.stk[this.ptr++]="char";
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f141(){
		//#line 14948: /ac 1 def /cc 2 def /tc 2 def /xc 2 def /ec 2 def /bc 2.25 def
		this.stk[this.ptr++]="ac";
		this.stk[this.ptr++]=1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="cc";
	...
	function $f142(){
		//#line 14991: dup cws exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 14992: /j exch length j add def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	function $f143(){
		//#line 14998: 2 string dup 0 msg i get put dup 1 msg i 1 add get put Avals exch get addtocws
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
	...
	function $f144(){
		//#line 15004: Avals [-1 lC lT lX lE lB] newmode get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=-1;
	...
	function $f145(){
		...
		//#line 15002: /newmode lookup def
		this.stk[this.ptr++]="newmode";
		var t=this.dstk.get("lookup");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15003: newmode mode ne {
		var t=this.dstk.get("newmode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15008: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f147(){
		//#line 15018: in exch 3 getinterval 0 exch {add 40 mul} forall 40 idiv 1 add
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f148(){
		...
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 15019: dup 256 idiv exch 256 mod
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f149(){
		//#line 15015: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15016: mark
		this.stk[this.ptr++]=Infinity;
		//#line 15017: 0 3 in length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15021: counttomark array astore exch pop
		for (var i=this.ptr-1; i>=0 && this.stk[i]!==Infinity; i--);
	...
	function $f150(){
		//#line 15030: i msglen eq {exit} if
		return -1;
	}
	function $f151(){
		//#line 15031: encvals mode get msg i get known not {exit} if
		return -1;
	}
	function $f152(){
		//#line 15034: ctxvals 0 p getinterval CTXvalstocws addtocws
	...
	function $f153(){
		//#line 15044: encvals mode get exch get aload pop
	...
	function $f155(){
		//#line 15043: dup encvals mode get exch known {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("encvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mode");
		...
		//#line 15045: } {  % Unencodable X12 characters
	...
	function $f156(){
		//#line 15052: [
		this.stk[this.ptr++]=Infinity;
		//#line 15053: ctxvals 0 p getinterval aload pop
		var t=this.dstk.get("ctxvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 15055: ] CTXvalstocws addtocws
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15056: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15057: /i msglen def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f157(){
		//#line 15062: [
		this.stk[this.ptr++]=Infinity;
		//#line 15063: ctxvals 0 p getinterval aload pop
		var t=this.dstk.get("ctxvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 15065: encvals mode get sft1 get aload pop
		var t=this.dstk.get("encvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 15066: ] CTXvalstocws addtocws
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15067: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15068: /i msglen def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f158(){
		//#line 15073: ctxvals 0 p getinterval CTXvalstocws addtocws
		var t=this.dstk.get("ctxvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15075: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15076: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15077: /i msglen def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f159(){
		//#line 15082: ctxvals 0 p getinterval CTXvalstocws addtocws
		var t=this.dstk.get("ctxvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15083: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15084: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15085: /i msglen def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f160(){
		//#line 15040: /remcws numremcws j p 3 idiv 2 mul add get def
		...
		this.stk[this.ptr++]=Infinity;
		//#line 15042: msg i msglen i sub getinterval {
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15050: remcws 2 eq remvals length 3 eq and {
		...
		//#line 15060: remcws 2 eq remvals length 2 eq and mode X ne and {
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 15071: remcws 2 eq remvals length 1 eq and {
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 15080: remcws 1 eq remvals length 1 eq and {
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	function $f161(){
		...
		//#line 15039: msglen i sub 3 le {  % Check end of data conditions
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f162(){
		...
		//#line 15090: encvals mode get msg i get get
		var t=this.dstk.get("encvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 15091: dup ctxvals exch p exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("ctxvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15092: /p exch length p add def
		this.stk[this.ptr++]="p";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	function $f163(){
		//#line 15099: p 3 mod 0 eq {exit} if
		return -1;
	}
	function $f164(){
		//#line 15099: p 3 mod 0 eq {exit} if
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15101: /p p encvals mode get msg i get get length sub def
		this.stk[this.ptr++]="p";
		var t=this.dstk.get("p");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("encvals");
	...
	function $f165(){
		//#line 15111: 2 string dup 0 msg i get put dup 1 msg i 1 add get put Avals exch get addtocws
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
	...
	function $f166(){
		//#line 15114: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f168(){
		...
		//#line 15103: [
		this.stk[this.ptr++]=Infinity;
		//#line 15104: ctxvals 0 p getinterval aload pop
		var t=this.dstk.get("ctxvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 15105: ] CTXvalstocws addtocws
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		if (i < 0) throw "array: underflow";
		var t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15107: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15109: i msglen ne {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f169(){
		...
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15026: /ctxvals 2500 array def
	...
	function $f170(){
		//#line 15129: in exch 4 getinterval 0 exch {or 6 bitshift} forall -6 bitshift
		if (typeof(this.stk[this.ptr-1])=="boolean") this.stk[this.ptr-2]=this.stk[this.ptr-2]||this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]|this.stk[this.ptr-1];
		this.ptr--;
		this.stk[this.ptr++]=6;
	...
	function $f171(){
		...
		this.ptr--;
		//#line 15130: dup -16 bitshift 255 and exch
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 15131: dup -8 bitshift 255 and exch
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=-8;
		if (this.stk[this.ptr-1]<0) this.stk[this.ptr-2]>>>=-this.stk[this.ptr-1];
		else this.stk[this.ptr-2]<<=this.stk[this.ptr-1];
	...
	function $f172(){
		//#line 15123: /in exch def
		this.stk[this.ptr++]="in";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15124: /inlen in length def
		...
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15125: /outlen in length 4 div 3 mul ceiling cvi def
		...
		this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15126: /in [ in aload pop 0 0 0 ] def
		this.stk[this.ptr++]="in";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("in");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15134: counttomark array astore exch pop
		for (var i=this.ptr-1; i>=0 && this.stk[i]!==Infinity; i--);
		if (i==-1) throw "counttomark: underflow";
		this.stk[this.ptr]=this.ptr-i-1;
		this.ptr++;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 15135: 0 outlen getinterval
		this.stk[this.ptr++]=0;
	...
	function $f173(){
		//#line 15144: i msglen eq {exit} if
		return -1;
	}
	function $f174(){
		//#line 15145: Evals msg i get known not {exit} if
		return -1;
	}
	function $f175(){
		//#line 15147: lookup mode ne {exit} if
		return -1;
	}
	function $f176(){
		//#line 15153: Evals exch get aload pop
		var t=this.dstk.get("Evals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f178(){
		//#line 15152: dup Evals exch known {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("Evals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 15154: } {  % Unencodable EDIFACT characters
	...
	function $f179(){
		//#line 15161: edifactvals 0 p getinterval Evalstocws addtocws
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15162: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15163: Avals msg i 1 add get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15164: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15165: /i msglen def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f180(){
		//#line 15170: edifactvals 0 p getinterval Evalstocws addtocws
		var t=this.dstk.get("edifactvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15171: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15172: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15173: /i msglen def
		this.stk[this.ptr++]="i";
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f181(){
		//#line 15149: /remcws numremcws j p 4 idiv 3 mul add get def
		this.stk[this.ptr++]="remcws";
		var t=this.dstk.get("numremcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		...
		this.stk[this.ptr++]="remvals";
		this.stk[this.ptr++]=Infinity;
		//#line 15151: msg i msglen i sub getinterval {
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15159: remcws 2 eq remvals length 2 eq and {
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 15168: remcws 2 eq remcws 1 eq or remvals length 1 eq and {
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	function $f182(){
		...
		//#line 15148: msglen i sub 2 le {  % Check end of data conditions
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f183(){
		...
		//#line 15178: Evals msg i get get
		var t=this.dstk.get("Evals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 15179: dup edifactvals exch p exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("edifactvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15180: /p exch length p add def
		this.stk[this.ptr++]="p";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	function $f184(){
		...
		this.ptr--;
		//#line 15189: dup edifactvals exch p exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("edifactvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15190: /p exch length p add def
		this.stk[this.ptr++]="p";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	function $f185(){
		//#line 15197: 2 string dup 0 msg i get put dup 1 msg i 1 add get put Avals exch get addtocws
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
	...
	function $f186(){
		//#line 15200: Avals msg i get get addtocws
		var t=this.dstk.get("Avals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f188(){
		//#line 15186: /remcws numremcws j p 4 idiv 3 mul add 1 sub get 1 sub def
		this.stk[this.ptr++]="remcws";
		var t=this.dstk.get("numremcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15187: remcws 0 ne {  % Unlatch if we haven't filled symbol
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 15192: edifactvals 0 p getinterval Evalstocws addtocws
		var t=this.dstk.get("edifactvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15193: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15195: i msglen ne {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msglen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f189(){
		...
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15140: /edifactvals 2100 array def
	...
	function $f190(){
		//#line 15210: i msglen eq {exit} if
		return -1;
	}
	function $f191(){
		//#line 15211: lookup mode ne {exit} if
		return -1;
	}
	function $f192(){
		//#line 15210: i msglen eq {exit} if
		...
		//#line 15212: bvals p msg i get put
	...
	function $f194(){
		//#line 15221: p 250 lt {p} {p 250 idiv 249 add p 250 mod} ifelse
		var t=this.dstk.get("p");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f195(){
	...
	function $f197(){
		//#line 15228: dup 256 ge {256 sub} if
		this.stk[this.ptr++]=256;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f198(){
		//#line 15226: /p exch def
		this.stk[this.ptr++]="p";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15227: j p add 1 add 149 mul 255 mod 1 add bvals p get add
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("p");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15229: bvals exch p exch put
		var t=this.dstk.get("bvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("p");
	...
	function $f199(){
		//#line 15209: /p 0 def /bvals 1558 array def {
		this.stk[this.ptr++]="p";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		...
		//#line 15216: /remcws numremcws j p add get 1 sub def
		this.stk[this.ptr++]="remcws";
		var t=this.dstk.get("numremcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		...
		this.stk[this.ptr++]="bvals";
		this.stk[this.ptr++]=Infinity;
		//#line 15218: remcws 0 eq i msglen eq and {  % Terminates symbol
		var t=this.dstk.get("remcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
		...
		//#line 15223: bvals 0 p getinterval aload pop
		var t=this.dstk.get("bvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("p");
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15225: 0 1 bvals length 1 sub {  % Pseudo-randomise based on codeword position
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("bvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15231: bvals addtocws
		var t=this.dstk.get("bvals");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("addtocws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 15232: /mode A def
		this.stk[this.ptr++]="mode";
		var t=this.dstk.get("A");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f200(){
		//#line 15238: i msglen ge {exit} if
		return -1;
	}
	function $f201(){
		//#line 15238: i msglen ge {exit} if
		...
		//#line 15239: [ /encA /encCTX /encCTX /encCTX /encE /encB ] mode get load exec
		this.stk[this.ptr++]=Infinity;
	...
	function $f202(){
		//#line 15247: /cws [ cws aload pop remcws {129} repeat ] def
		this.stk[this.ptr++]=129;
	}
	function $f203(){
		//#line 15251: dup 254 gt {254 sub} if
		this.stk[this.ptr++]=254;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f204(){
		//#line 15249: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15250: i 1 add 149 mul 253 mod 1 add 129 add
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		...
		//#line 15252: cws exch i exch put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("i");
	...
	function $f205(){
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15248: datlen 1 add 1 datlen remcws add 1 sub {
	...
	function $f206(){
		//#line 15271: cws length ncws ne           {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f207(){
		//#line 15272: urows 0 ne urows rows ne and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f208(){
		//#line 15273: ucols 0 ne ucols cols ne and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f209(){
		//#line 15274: okay {exit} if
		return -1;
	}
	function $f210(){
		//#line 15258: /m metrics i get def
		this.stk[this.ptr++]="m";
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15259: /rows m 0 get def                          % Rows in symbol
		this.stk[this.ptr++]="rows";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15260: /cols m 1 get def                          % Columns in symbol
		this.stk[this.ptr++]="cols";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15261: /regh m 2 get def                          % Horizontal regions
		this.stk[this.ptr++]="regh";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15262: /regv m 3 get def                          % Vertical regions
		this.stk[this.ptr++]="regv";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15263: /rscw m 4 get def                          % Error correction codewords
		this.stk[this.ptr++]="rscw";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15264: /rsbl m 5 get def                          % Error correction blocks
		this.stk[this.ptr++]="rsbl";
		var t=this.dstk.get("m");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=5;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15265: /mrows rows 2 regh mul sub def             % Rows in the mapping matrix
		this.stk[this.ptr++]="mrows";
		var t=this.dstk.get("rows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15266: /mcols cols 2 regv mul sub def             % Columns in the mapping matrix
		this.stk[this.ptr++]="mcols";
		var t=this.dstk.get("cols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15267: /rrows mrows regh idiv def                 % Rows per region
		...
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15268: /rcols mcols regv idiv def                 % Columns per region
		...
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15269: /ncws mrows mcols mul 8 idiv rscw sub def  % Data codewords
		this.stk[this.ptr++]="ncws";
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mcols");
	...
	function $f211(){
		//#line 15284: /cwbsize cws length rsbl idiv def
	...
	function $f212(){
		//#line 15286: i 7 le {/cwbsize 156 def} {/cwbsize 155 def} ifelse
		this.stk[this.ptr++]="cwbsize";
	...
	function $f215(){
		//#line 15290: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15291: cwb j cws j rsbl mul i add get put
	...
	function $f216(){
		//#line 15294: ecbs i [ rscw rsbl idiv {0} repeat ] put
		this.stk[this.ptr++]=0;
	}
	function $f217(){
		...
		//#line 15288: /cwb cwbsize array def 
		this.stk[this.ptr++]="cwb";
		var t=this.dstk.get("cwbsize");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15289: 0 1 cwbsize 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("cwbsize");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f218(){
		//#line 15298: /rsalog [ 1 255 { dup 2 mul dup 256 ge {301 xor} if } repeat ] def
	...
	function $f220(){
		//#line 15300: 1 1 255 {dup rsalog exch get exch rslog 3 1 roll put} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f221(){
		//#line 15305: rslog exch get exch rslog exch get add 255 mod rsalog exch get
		var t=this.dstk.get("rslog");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f222(){
		//#line 15307: pop pop 0
		this.ptr--;
		this.ptr--;
		this.stk[this.ptr++]=0;
	}
	function $f223(){
		//#line 15304: 2 copy 0 ne exch 0 ne and { 
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f224(){
		//#line 15312: /coeffs [ 1 rscw rsbl idiv {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f225(){
		//#line 15317: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15318: coeffs j coeffs j 1 sub get coeffs j get rsalog i get rsprod xor put
	...
	function $f226(){
		//#line 15314: /i exch def 
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15315: coeffs i coeffs i 1 sub get put
		var t=this.dstk.get("coeffs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 15320: coeffs 0 coeffs 0 get rsalog i get rsprod put
		var t=this.dstk.get("coeffs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("coeffs");
	...
	function $f227(){
		//#line 15335: j 0 gt { ecb p ecb p 1 add get ecb p get xor put } if
	...
	function $f228(){
		//#line 15332: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15333: /p ecb length j sub 1 sub def
		this.stk[this.ptr++]="p";
		var t=this.dstk.get("ecb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15334: ecb p t coeffs j get rsprod put
		var t=this.dstk.get("ecb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("p");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f229(){
		//#line 15330: /t exch cwb exch get ecb 0 get xor def 
		this.stk[this.ptr++]="t";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("cwb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15331: ecb length 1 sub -1 0 {
		var t=this.dstk.get("ecb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	function $f230(){
		//#line 15326: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15327: /cwb cwbs i get def
		this.stk[this.ptr++]="cwb";
		var t=this.dstk.get("cwbs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15329: 0 1 cwb length 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("cwb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f233(){
		//#line 15342: /ecbs [ ecbs 8 2 getinterval {} forall ecbs 0 8 getinterval {} forall ] def
	...
	function $f235(){
		//#line 15346: /cws [ cws {} forall rscw {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f236(){
		//#line 15348: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 15349: cws ncws i add ecbs i rsbl mod get i rsbl idiv get put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ncws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f237(){
		//#line 15358: 7 -1 0 {1 index exch get 48 sub exch} for pop
		this.stk[this.ptr++]=1;
		if (this.stk[this.ptr-1] >= this.ptr) throw "index: underflow";
		this.stk[this.ptr-1]=this.stk[this.ptr-2-this.stk[this.ptr-1]];
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f238(){
		//#line 15364: exch mrows add exch
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 15365: 4 mrows 4 add 8 mod sub add
		this.stk[this.ptr++]=4;
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
	...
	function $f239(){
		//#line 15368: mcols add exch
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 15369: 4 mcols 4 add 8 mod sub add exch
		this.stk[this.ptr++]=4;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
	...
	function $f240(){
		...
		//#line 15371: exch mcols mul add
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 15372: mmat exch 5 -1 roll put
	...
	function $f241(){
		...
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		//#line 15356: (00000000) 8 string copy dup 3 -1 roll 2 8 string cvrs 
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-1].subset(0,t.length);
		this.ptr-=2;
		//#line 15357: dup length 8 exch sub exch putinterval 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=8;
		...
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		//#line 15361: {  % Place each bit of the codeword in the shape, MSB first
	...
	function $f242(){
		//#line 15378: { 2 copy 2 sub exch 2 sub exch } bind  { 2 copy 1 sub exch 2 sub exch } bind
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f244(){
		//#line 15379: { 2 copy 2 sub exch 1 sub exch } bind  { 2 copy 1 sub exch 1 sub exch } bind
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f246(){
		//#line 15380: { 2 copy exch 1 sub exch } bind        { 2 copy 2 sub } bind
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f248(){
		//#line 15381: { 2 copy 1 sub } bind                  { 2 copy } bind
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f250(){
		//#line 15385: { mrows 1 sub 0 } bind  { mrows 1 sub 1 } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f252(){
		//#line 15386: { mrows 1 sub 2 } bind  { 0 mcols 2 sub } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f254(){
		//#line 15387: { 0 mcols 1 sub } bind  { 1 mcols 1 sub } bind
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f256(){
		//#line 15388: { 2 mcols 1 sub } bind  { 3 mcols 1 sub } bind
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f258(){
		//#line 15392: { mrows 3 sub 0 } bind  { mrows 2 sub 0 } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f260(){
		//#line 15393: { mrows 1 sub 0 } bind  { 0 mcols 4 sub } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f262(){
		//#line 15394: { 0 mcols 3 sub } bind  { 0 mcols 2 sub } bind
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
	...
	function $f264(){
		//#line 15395: { 0 mcols 1 sub } bind  { 1 mcols 1 sub } bind
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f266(){
		//#line 15399: { mrows 3 sub 0 } bind  { mrows 2 sub 0 } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f268(){
		//#line 15400: { mrows 1 sub 0 } bind  { 0 mcols 2 sub } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f270(){
		//#line 15401: { 0 mcols 1 sub } bind  { 1 mcols 1 sub } bind
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f272(){
		//#line 15402: { 2 mcols 1 sub } bind  { 3 mcols 1 sub } bind
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f274(){
		//#line 15406: { mrows 1 sub 0 } bind  { mrows 1 sub mcols 1 sub } bind
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f276(){
		//#line 15407: { 0 mcols 3 sub } bind  { 0 mcols 2 sub } bind
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
	...
	function $f278(){
		//#line 15408: { 0 mcols 1 sub } bind  { 1 mcols 3 sub } bind
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f280(){
		//#line 15409: { 1 mcols 2 sub } bind  { 1 mcols 1 sub } bind
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("mcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
	...
	function $f282(){
		//#line 15412: /mmat [ mrows mcols mul {-1} repeat ] def
		this.stk[this.ptr++]=-1;
	}
	function $f283(){
		//#line 15413: cws length 1 sub -1 0 {cws exch get} for  % Reverse cws onto stack
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f289(){
		//#line 15431: 2 copy exch mcols mul add mmat exch get -1 eq {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f290(){
		//#line 15436: 2 copy mcols lt exch 0 ge and not {exit} if
		return -1;
	}
	function $f291(){
		//#line 15430: 2 copy 0 ge exch mrows lt and {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
		...
		//#line 15435: 2 add exch 2 sub exch
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=2;
	...
	function $f293(){
		//#line 15442: 2 copy exch mcols mul add mmat exch get -1 eq {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
	...
	function $f294(){
		//#line 15447: 2 copy 0 ge exch mrows lt and not {exit} if
		return -1;
	}
	function $f295(){
		//#line 15441: 2 copy mcols lt exch 0 ge and {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
		...
		//#line 15446: 2 sub exch 2 add exch
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=2;
	...
	function $f296(){
		//#line 15451: 2 copy mcols lt exch mrows lt or not {pop pop exit} if
		this.ptr--;
		this.ptr--;
		return -1;
	}
	function $f297(){
		//#line 15416: 2 copy 0 eq exch mrows eq and {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
		...
		//#line 15419: 2 copy 0 eq exch mrows 2 sub eq and mcols 4 mod 0 ne and {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
		...
		//#line 15422: 2 copy 0 eq exch mrows 2 sub eq and mcols 8 mod 4 eq and {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
		...
		//#line 15425: 2 copy 2 eq exch mrows 4 add eq and mcols 8 mod 0 eq and {
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
			for (var n=this.stk[--this.ptr],t=this.ptr+n; this.ptr<t; this.ptr++) this.stk[this.ptr]=this.stk[this.ptr-n];
		} else if (this.stk[this.ptr-1] instanceof BWIPJS.psstring||this.stk[this.ptr-1] instanceof BWIPJS.psarray) {
		...
		//#line 15429: { % loop for sweeping upwards
		...
		//#line 15438: 3 add exch 1 add exch
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		//#line 15440: { % loop for sweeping downwards
		...
		//#line 15449: 1 add exch 3 add exch
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr++]=3;
	...
	function $f298(){
		//#line 15457: mmat mrows mcols 1 sub mul 2 sub [1 0] putinterval
		var t=this.dstk.get("mmat");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 15458: mmat mrows mcols mul 2 sub [0 1] putinterval
		var t=this.dstk.get("mmat");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("mrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f299(){
		//#line 15466: i rrows 2 add mod 0 eq { pixs i cols mul [ cols 2 idiv {1 0} repeat ] putinterval } if  
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=0;
	}
	function $f300(){
	...
	function $f301(){
		//#line 15467: i rrows 2 add mod rrows 1 add eq { pixs i cols mul [ cols {1} repeat ] putinterval } if 
		this.stk[this.ptr++]=1;
	}
	function $f302(){
		//#line 15467: i rrows 2 add mod rrows 1 add eq { pixs i cols mul [ cols {1} repeat ] putinterval } if 
	...
	function $f303(){
		//#line 15471: j rcols 2 add mod 0 eq { pixs i cols mul j add 1 put } if
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f304(){
		//#line 15472: j rcols 2 add mod rcols 1 add eq { pixs i cols mul j add i 2 mod put } if
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f305(){
		//#line 15474: pixs i cols mul j add mmat cwpos get put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		//#line 15475: /cwpos cwpos 1 add def
	...
	function $f306(){
		...
		//#line 15473: j rcols 2 add mod 0 ne j rcols 2 add mod rcols 1 add ne and {
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("rcols");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f308(){
		...
		//#line 15468: i rrows 2 add mod 0 ne i rrows 2 add mod rrows 1 add ne and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("rrows");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 14663: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 14665: /options exch def
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14666: /barcode exch def
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14668: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14669: /columns 0 def
	this.stk[this.ptr++]="columns";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14670: /rows 0 def
	this.stk[this.ptr++]="rows";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14671: /parse false def
	this.stk[this.ptr++]="parse";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14672: /parsefnc false def
	this.stk[this.ptr++]="parsefnc";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14675: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 14685: /columns columns cvi def
	this.stk[this.ptr++]="columns";
	var t=this.dstk.get("columns");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14686: /rows rows cvi def
	this.stk[this.ptr++]="rows";
	var t=this.dstk.get("rows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	...
	//#line 14709: /barlen barcode length def
	...
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14712: /fnc1 -1 def  /prog -2 def  /m05 -3 def  /m06 -4 def
	...
	this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14719: /msg barlen array def
	this.stk[this.ptr++]="msg";
	var t=this.dstk.get("barlen");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14720: /i 0 def /j 0 def {
	this.stk[this.ptr++]="i";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="j";
	...
	//#line 14735: /msg msg 0 j getinterval def
	this.stk[this.ptr++]="msg";
	var t=this.dstk.get("msg");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14736: /msglen msg length def
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14776: /urows rows def
	this.stk[this.ptr++]="urows";
	var t=this.dstk.get("rows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14777: /ucols columns def
	this.stk[this.ptr++]="ucols";
	var t=this.dstk.get("columns");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14778: /fullcws [] def
	this.stk[this.ptr++]="fullcws";
	...
	//#line 14806: /lC    -5 def  /lB    -6 def  /lX    -7 def  /lT    -8 def  /lE    -9 def  /unl -10 def
	...
	this.stk[this.ptr++]=-10;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14807: /sapp -11 def  /usft -12 def  /sft1 -13 def  /sft2 -14 def  /sft3 -15 def  /eci -16 def  /pad -17 def
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=129;
	//#line 14813: 0 1 99 {  % Double digits
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	...
	this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14911: /encvals [ Avals Cvals Tvals Xvals Evals Bvals ] def
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 14945: /A 0 def  /C 1 def  /T 2 def  /X 3 def  /E 4 def  /B 5 def
	this.stk[this.ptr++]="A";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="C";
	...
	//#line 15233: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15236: /cws 1558 array def
	this.stk[this.ptr++]="cws";
	this.stk[this.ptr++]=1558;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15237: /mode A def /i 0 def /j 0 def {
	this.stk[this.ptr++]="mode";
	var t=this.dstk.get("A");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	//#line 15241: /cws cws 0 j getinterval def
	this.stk[this.ptr++]="cws";
	var t=this.dstk.get("cws");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15244: /datlen cws length def
	...
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15245: /remcws numremcws j 1 sub get 1 sub def
	this.stk[this.ptr++]="remcws";
	var t=this.dstk.get("numremcws");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("j");
	...
	//#line 15279: /cwbs rsbl array def  % Array of data codeword blocks
	this.stk[this.ptr++]="cwbs";
	var t=this.dstk.get("rsbl");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15280: /ecbs rsbl array def  % Array of error correction blocks
	this.stk[this.ptr++]="ecbs";
	var t=this.dstk.get("rsbl");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15281: 0 1 rsbl 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("rsbl");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15299: /rslog 256 array def
	...
	//#line 15322: /coeffs coeffs 0 coeffs length 1 sub getinterval def
	this.stk[this.ptr++]="coeffs";
	var t=this.dstk.get("coeffs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15325: 0 1 cwbs length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("cwbs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 15414: 4 0  % Starting row and column
	this.stk[this.ptr++]=4;
	this.stk[this.ptr++]=0;
	//#line 15415: { % loop
	...
	//#line 15456: mmat mrows mcols mul 1 sub get -1 eq {
	var t=this.dstk.get("mmat");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("mrows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 15462: /pixs rows cols mul array def
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15463: /cwpos 0 def
	this.stk[this.ptr++]="cwpos";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 15464: 0 1 rows 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("rows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 15482: <<
	this.stk[this.ptr++]=Infinity;
	//#line 15483: /ren //renmatrix
	this.stk[this.ptr++]="ren";
	var t=this.dstk.get("renmatrix");
	this.stk[this.ptr++]=t;
	//#line 15484: /pixs pixs
	this.stk[this.ptr++]="pixs";
	var t=this.dstk.get("pixs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 15485: /pixx cols
	this.stk[this.ptr++]="pixx";
	var t=this.dstk.get("cols");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 15486: /pixy rows
	this.stk[this.ptr++]="pixy";
	var t=this.dstk.get("rows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 15487: /height rows 2 mul 72 div
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 15488: /width cols 2 mul 72 div
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 15492: dontdraw not //renmatrix if
