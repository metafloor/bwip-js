...
BWIPJS.bwipp["databarlimitedcomposite"]=function() {
	...
	function $f0(){
		//#line 19777: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 19778: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 19780: currentdict end /options exch def
	...
	function $f5(){
		//#line 19782: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 19786: /linear exch def
		this.stk[this.ptr++]="linear";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 19787: pop
		this.ptr--;
		//#line 19788: /comp exch def
	...
	function $f8(){
		//#line 19808: 1 linsbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
		this.stk[this.ptr++]=1;
	}
	function $f9(){
		//#line 19808: 1 linsbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
	...
	//#line 19766: 20 dict begin            % Confine variables to local scope
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 19768: /options exch def
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19769: /barcode exch def
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19771: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19774: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 19793: gsave
	this.gsave();
	//#line 19795: options (lintype) (databarlimited) put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19796: options (linkage) true put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19797: options (inkspread) (0) put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19798: options (dontdraw) true put
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 19801: linear options //databarlimited exec
	...
	//#line 19802: dup (sbs) get /linsbs exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 19803: dup (bhs) get 0 get 72 mul /linheight exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	//#line 19809: counttomark 1 sub array astore /sep exch def pop pop
	...
	this.ptr--;
	this.ptr--;
	//#line 19810: sep 0 [0 0 0] putinterval
	var t=this.dstk.get("sep");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=BWIPJS.psarray([0,0,0]);
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 19811: sep sep length 4 sub [0 0 0 0] putinterval
	var t=this.dstk.get("sep");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("sep");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 19812: 0 linheight rmoveto <<
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr++]=1;
	//#line 19817: /height 1 72 div
	this.stk[this.ptr++]="height";
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 19818: /width sep length 72 div
	...
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 19819: /opt options
	this.stk[this.ptr++]="opt";
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 19820: >> //renmatrix exec
	var t = {};
	...
	var t=this.stk[--this.ptr];
	if (t instanceof Function) t.call(this); else this.eval(t);
	//#line 19823: comp options //gs1-cc exec 
	...
	var t=this.stk[--this.ptr];
	if (t instanceof Function) t.call(this); else this.eval(t);
	//#line 19824: dup (pixx) get 72 exch sub 1 rmoveto 
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
