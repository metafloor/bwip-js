...
BWIPJS.bwipp["pdf417"]=function() {
	...
	function $f18(){
		...
		if (t23 < 0) t=this.stk.splice(this.ptr-t22, -t23);
		else t=this.stk.splice(this.ptr-t22, t22-t23);
	...
	function $f81(){
		...
		this.forall(this.stk[--this.ptr],t87);
		this.stk[this.ptr++]="minseq";
		this.xget("e");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]=Infinity;
	...
	function $f91(){
		...
		this.forall(this.stk[--this.ptr],t108);
		for (var i = this.ptr-1; i >= 0 && this.stk[i] !== Infinity; i--) ;
		t = this.stk.splice(i+1, this.ptr-1-i);
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
	...
	function $f93(){
		...
		if (t122 < 0) t=this.stk.splice(this.ptr-t121, -t122);
		else t=this.stk.splice(this.ptr-t121, t121-t122);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.xget("j");
	...
	function $f118(){
		...
		if (t154 < 0) t=this.stk.splice(this.ptr-t153, -t154);
		else t=this.stk.splice(this.ptr-t153, t153-t154);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		BWIPJS.set(this.stk[this.ptr-3],this.stk[this.ptr-2],this.stk[this.ptr-1]);
		this.ptr-=3;
	}
	...
	function $f127(){
		...
		for (var t183=t180; t181<0 ? t183>=t182 : t183<=t182; t183+=t181) {
	...
	function $f128(){
		...
		if (t191 < 0) t=this.stk.splice(this.ptr-t190, -t191);
		else t=this.stk.splice(this.ptr-t190, t190-t191);
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr-2]=BWIPJS.get(this.stk[this.ptr-2],this.stk[this.ptr-1]);
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f142(){
		...
		this.forall(this.stk[--this.ptr],t209);
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr++]=1;
	...
	function $f143(){
		...
		this.forall(this.stk[--this.ptr],t206);
		this.xget("cws");
		this.xget("c");
		this.xget("i");
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		...
		this.forall(this.stk[--this.ptr],t208);
		this.xget("compact");
