...
BWIPJS.bwipp["ean8"]=function() {
	function $f0(){
		//#line 1019: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 1020: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 1022: currentdict end /options exch def
	...
	function $f5(){
		//#line 1024: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 1032: addontextfont (unset) ne {/addontextfont addontextfont cvlit def} if
	...
	function $f7(){
		//#line 1033: addontextsize (unset) ne {/addontextsize addontextsize cvr def} if
	...
	function $f8(){
		//#line 1034: addontextxoffset (unset) ne {/addontextxoffset addontextxoffset cvr def} if
	...
	function $f9(){
		//#line 1035: addontextyoffset (unset) ne {/addontextyoffset addontextyoffset cvr def} if
	...
	function $f10(){
		//#line 1039: /barcode exch def
		this.stk[this.ptr++]="barcode";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1040: pop
		this.ptr--;
		//#line 1041: /addon exch def
	...
	function $f12(){
		//#line 1049: /bwipp.ean8badLength (EAN-8 must be 7 or 8 digits) //raiseerror exec
	...
	function $f13(){
		//#line 1053: /bwipp.ean8badCharacter (EAN-8 must contain only digits) //raiseerror exec
	...
	function $f14(){
		//#line 1052: dup 48 lt exch 57 gt or {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f15(){
		//#line 1057: /bwipp.ean8badAddOnLength (Add-on for EAN-8 must be 2 or 5 digits) //raiseerror exec
	...
	function $f16(){
		//#line 1067: /checksum barchar checksum add def
	...
	function $f17(){
		//#line 1069: /checksum barchar 3 mul checksum add def
		this.stk[this.ptr++]="checksum";
		var t=this.dstk.get("barchar");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
	...
	function $f18(){
		//#line 1064: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1065: /barchar barcode i get 48 sub def
	...
	function $f19(){
		//#line 1075: /bwipp.ean8badCheckDigit (Incorrect EAN-8 check digit provided) //raiseerror exec
	...
	function $f20(){
		//#line 1074: barcode 7 get checksum 48 add ne {
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=7;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f21(){
		//#line 1101: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1102: barcode i 1 getinterval barchars exch search
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 1103: pop                                % Discard true leaving pre
		this.ptr--;
		//#line 1104: length /indx exch def              % indx is the length of pre
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]="indx";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1105: pop pop                            % Discard seek and post
		this.ptr--;
		this.ptr--;
		//#line 1106: /enc encs indx get def             % Get the indxth encoding
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1107: sbs i 4 mul 3 add enc putinterval  % Put encoded digit into sbs
		...
		//#line 1108: txt i [barcode i 1 getinterval i 7 mul textxoffset add textyoffset textfont textsize] put
	...
	function $f22(){
		//#line 1117: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1118: barcode i 1 getinterval barchars exch search
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 1119: pop                                % Discard true leaving pre
		this.ptr--;
		//#line 1120: length /indx exch def              % indx is the length of pre
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]="indx";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1121: pop pop                            % Discard seek and post
		this.ptr--;
		this.ptr--;
		//#line 1122: /enc encs indx get def             % Get the indxth encoding
		this.stk[this.ptr++]="enc";
		var t=this.dstk.get("encs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("indx");
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1123: sbs i 4 mul 8 add enc putinterval  % Put encoded digit into sbs
		var t=this.dstk.get("sbs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 1124: txt i [barcode i 1 getinterval i 7 mul textxoffset add 4 add textyoffset textfont textsize] put
		var t=this.dstk.get("txt");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f23(){
		//#line 1130: /sbs [sbs {48 sub} forall] def
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f24(){
		//#line 1132: /bhs [height height 8{height .075 sub}repeat height height 8{height .075 sub}repeat height height] def
	...
	function $f26(){
		//#line 1133: /bbs [0 0 8{.075}repeat 0 0 8{.075}repeat 0 0] def
		this.stk[this.ptr++]=0.075;
	}
	function $f27(){
		//#line 1133: /bbs [0 0 8{.075}repeat 0 0 8{.075}repeat 0 0] def
	...
	function $f29(){
		//#line 1135: /bhs [22{height}repeat] def
		var t=this.dstk.get("height");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f30(){
		//#line 1136: /bbs [22{0}repeat] def
		this.stk[this.ptr++]=0;
	}
	function $f31(){
		//#line 1135: /bhs [22{height}repeat] def
	...
	function $f32(){
		//#line 1147: /textxoffset addontextxoffset (unset) ne {addontextxoffset} {67 addongap add} ifelse
		var t=this.dstk.get("addontextxoffset");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f33(){
	...
	function $f34(){
		//#line 1148: addontextyoffset (unset) ne {/textyoffset addontextyoffset} if
		this.stk[this.ptr++]="textyoffset";
		var t=this.dstk.get("addontextyoffset");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f35(){
		//#line 1149: /textsize addontextsize (unset) ne {addontextsize} {textsize} ifelse
		var t=this.dstk.get("addontextsize");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f36(){
	...
	function $f37(){
		//#line 1150: /textfont addontextfont (unset) ne {addontextfont} {textfont} ifelse
		var t=this.dstk.get("addontextfont");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	function $f38(){
	...
	function $f39(){
		//#line 1152: addon length 2 eq {addon addopts //ean2 exec} if
	...
	function $f40(){
		//#line 1153: addon length 5 eq {addon addopts //ean5 exec} if
		var t=this.dstk.get("addon");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("addopts");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f41(){
		//#line 1156: /bhs [bhs aload pop addcode (bhs) get {.075 sub} forall] def
		this.stk[this.ptr++]=0.075;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f42(){
		//#line 1157: /bbs [bbs aload pop addcode (bbs) get {.075 add} forall] def
		this.stk[this.ptr++]=0.075;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f43(){
		...
		this.stk[this.ptr++]=Infinity;
		//#line 1144: /dontdraw true
		this.stk[this.ptr++]="dontdraw";
		this.stk[this.ptr++]=true;
		//#line 1145: /includetext true
		this.stk[this.ptr++]="includetext";
		this.stk[this.ptr++]=true;
		//#line 1146: /height height 0.15 sub
		...
		//#line 1154: /addcode exch def
		this.stk[this.ptr++]="addcode";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1155: /sbs [sbs aload pop addongap addcode (sbs) get aload pop] def
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1158: /txt [txt aload pop addcode (txt) get aload pop] def
		this.stk[this.ptr++]="txt";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("txt");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 1159: /guardrightypos height 72 mul 6 sub def
	...
	//#line 997: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 999: /options exch def                  % We are given an option string
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1000: /barcode exch def                  % We are given a barcode string
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1002: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1003: /includetext false def              % Enable/disable text
	this.stk[this.ptr++]="includetext";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1004: /textfont /Helvetica def
	this.stk[this.ptr++]="textfont";
	this.stk[this.ptr++]="Helvetica";
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1005: /textsize 12 def
	this.stk[this.ptr++]="textsize";
	this.stk[this.ptr++]=12;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1006: /textxoffset 4 def
	this.stk[this.ptr++]="textxoffset";
	this.stk[this.ptr++]=4;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1007: /textyoffset -4 def
	this.stk[this.ptr++]="textyoffset";
	this.stk[this.ptr++]=-4;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1008: /height 1 def
	this.stk[this.ptr++]="height";
	this.stk[this.ptr++]=1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1009: /addongap 12 def
	this.stk[this.ptr++]="addongap";
	this.stk[this.ptr++]=12;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1010: /addontextfont (unset) def
	this.stk[this.ptr++]="addontextfont";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1011: /addontextsize (unset) def
	this.stk[this.ptr++]="addontextsize";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1012: /addontextxoffset (unset) def
	this.stk[this.ptr++]="addontextxoffset";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1013: /addontextyoffset (unset) def
	this.stk[this.ptr++]="addontextyoffset";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1016: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 1026: /textfont textfont cvlit def
	this.stk[this.ptr++]="textfont";
	var t=this.dstk.get("textfont");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1027: /textsize textsize cvr def
	this.stk[this.ptr++]="textsize";
	var t=this.dstk.get("textsize");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseFloat(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1028: /textxoffset textxoffset cvr def
	this.stk[this.ptr++]="textxoffset";
	var t=this.dstk.get("textxoffset");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseFloat(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1029: /textyoffset textyoffset cvr def
	this.stk[this.ptr++]="textyoffset";
	var t=this.dstk.get("textyoffset");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseFloat(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1030: /height height cvr def
	this.stk[this.ptr++]="height";
	var t=this.dstk.get("height");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseFloat(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1031: /addongap addongap cvr def
	this.stk[this.ptr++]="addongap";
	var t=this.dstk.get("addongap");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseFloat(this.stk[this.ptr-1]);
	...
	//#line 1048: barcode length 7 ne barcode length 8 ne and {
	var t=this.dstk.get("barcode");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	//#line 1056: addon length 0 ne addon length 2 ne and addon length 5 ne and {
	var t=this.dstk.get("addon");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	...
	//#line 1061: /pad 8 string def
	this.stk[this.ptr++]="pad";
	this.stk[this.ptr++]=8;
	this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1062: /checksum 0 def
	this.stk[this.ptr++]="checksum";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1063: 0 1 6 {
	...
	//#line 1072: /checksum 10 checksum 10 mod sub 10 mod def
	this.stk[this.ptr++]="checksum";
	...
	//#line 1078: pad 0 barcode putinterval      % Add barcode to the start of the pad
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 1079: pad 7 checksum 48 add put      % Put ascii for checksum at end of pad
	var t=this.dstk.get("pad");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=7;
	var t=this.dstk.get("checksum");
	...
	//#line 1084: [ (3211) (2221) (2122) (1411) (1132)
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1090: /barchars (0123456789) def
	this.stk[this.ptr++]="barchars";
	this.stk[this.ptr++]=BWIPJS.psstring("0123456789");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1092: /sbs 43 string def
	this.stk[this.ptr++]="sbs";
	this.stk[this.ptr++]=43;
	this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1093: /txt 8 array def
	this.stk[this.ptr++]="txt";
	this.stk[this.ptr++]=8;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1096: sbs 0 encs 10 get putinterval
	var t=this.dstk.get("sbs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	var t=this.dstk.get("encs");
	...
	//#line 1112: sbs 4 4 mul 3 add encs 11 get putinterval
	var t=this.dstk.get("sbs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=4;
	this.stk[this.ptr++]=4;
	...
	//#line 1128: sbs 40 encs 12 get putinterval
	var t=this.dstk.get("sbs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 1139: /guardrightypos 0 def
	this.stk[this.ptr++]="guardrightypos";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 1142: addon () ne {
	...
	var t=this.dstk.get("txt");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 1169: /opt options
	this.stk[this.ptr++]="opt";
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 1170: /guardleftpos 10
	this.stk[this.ptr++]="guardleftpos";
	this.stk[this.ptr++]=10;
	//#line 1171: /guardrightpos 10
	this.stk[this.ptr++]="guardrightpos";
	this.stk[this.ptr++]=10;
	//#line 1172: /guardrightypos guardrightypos
	this.stk[this.ptr++]="guardrightypos";
	var t=this.dstk.get("guardrightypos");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 1173: /borderbottom 5
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 1176: dontdraw not //renlinear if
