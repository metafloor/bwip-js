...
BWIPJS.bwipp["codeone"]=function() {
	...
	function $f0(){
		//#line 17982: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 17983: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 17985: currentdict end /options exch def
	...
	function $f5(){
		//#line 17987: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 17990: stype {/raw true def} if
		this.stk[this.ptr++]="raw";
		this.stk[this.ptr++]=true;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f7(){
		//#line 17999: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		//#line 18000: length j add 1 add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18001: pop
		this.ptr--;
		//#line 18002: dup 0 3 getinterval cvi msg exch j 1 sub exch put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		...
		this.ptr-=3;
		//#line 18003: dup length 3 sub 3 exch getinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=3;
	...
	function $f8(){
		//#line 18005: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18006: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18007: /barcode msg 0 j getinterval def
	...
	function $f10(){
		//#line 17994: /msg barcode length string def
	...
	function $f11(){
		//#line 18015: raw {/encoding (raw) def} if
		this.stk[this.ptr++]="encoding";
		this.stk[this.ptr++]=BWIPJS.psstring("raw");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f12(){
		//#line 18021: i barlen eq {exit} if
		return -1;
	}
	function $f13(){
		//#line 18021: i barlen eq {exit} if
		...
		//#line 18022: /cw barcode i 1 add 3 getinterval cvi def
	...
	function $f14(){
		//#line 18018: /cws barlen array def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("barlen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18019: /i 0 def /j 0 def
		this.stk[this.ptr++]="i";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="j";
		...
		//#line 18027: /cws cws 0 j getinterval def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
	...
	function $f15(){
		//#line 18034: i barlen eq {exit} if
		return -1;
	}
	function $f16(){
		//#line 18038: cws j barcode i 2 getinterval cvi 130 add put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f17(){
		//#line 18042: cws j char 1 add put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f18(){
		//#line 18037: barcode i 1 add get dup 48 ge exch 57 le and {  % Digit pair
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f19(){
		//#line 18047: cws j char 1 add put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f20(){
		...
		this.ptr-=3;
		//#line 18052: cws j 1 add char 127 sub put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f21(){
		//#line 18046: } { char 127 le {  % ASCII
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=127;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]<=this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=$f19;
		//#line 18050: } {  % Extended ASCII
		this.stk[this.ptr++]=$f20;
		//#line 18055: } ifelse } ifelse
	...
	function $f22(){
		...
		//#line 18035: /char barcode i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18036: char 48 ge char 57 le and i barlen 1 sub lt and {
		var t=this.dstk.get("char");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]>=this.stk[this.ptr-1]; this.ptr--;
	...
	function $f23(){
		//#line 18031: /cws barlen 2 mul array def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("barlen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		...
		//#line 18057: /cws cws 0 j getinterval def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
	...
	function $f24(){
		//#line 18096: version (unset) ne version vers ne and {/okay false def} if  % The version must match that supplied
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f25(){
		//#line 18097: cws length dcws gt {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f26(){
		//#line 18098: okay {exit} if
		return -1;
	}
	function $f27(){
		//#line 18082: /m metrics i get def
		this.stk[this.ptr++]="m";
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18083: /vers m 0 get def           % Version of symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18084: /rows m 1 get def           % Rows in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18085: /cols m 2 get def           % Columns in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18086: /dcol m 3 get def           % Data columns in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18087: /dcws m 4 get def           % Data codewords in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18088: /rscw m 5 get def           % Error correction codewords 
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18089: /rsbl m 6 get def           % Error correction blocks
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18090: /riso m 7 get def           % Riser offset
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18091: /risi m 8 get def           % Riser interval
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18092: /risl m 9 get def           % Riser length
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18093: /dcpb dcws rsbl idiv def    % Data codewords per block
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18094: /ecpb rscw rsbl idiv def    % Error codewords per block
	...
	function $f28(){
		//#line 18104: /cws [ cws aload pop dcws cws length sub {129} repeat ] def
	...
	function $f30(){
		//#line 18114: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18115: cwb j cws j rsbl mul i add get put
	...
	function $f31(){
		//#line 18111: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18112: /cwb dcpb array def 
		this.stk[this.ptr++]="cwb";
		var t=this.dstk.get("dcpb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18113: 0 1 dcpb 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("dcpb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f32(){
		//#line 18121: /gf stype {32} {256} ifelse def
	...
	function $f34(){
		//#line 18123: /pm stype {37} {301} ifelse def
	...
	function $f36(){
		//#line 18124: /rsalog [ 1 gf-1 { dup 2 mul dup gf ge {pm xor} if } repeat ] def
	...
	function $f38(){
		//#line 18126: 1 1 gf-1 {dup rsalog exch get exch rslog 3 1 roll put} for
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	function $f39(){
		//#line 18129: rslog exch get exch rslog exch get add gf-1 mod rsalog exch get
		var t=this.dstk.get("rslog");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f40(){
		//#line 18131: pop pop 0
		this.ptr--;
		this.ptr--;
		this.stk[this.ptr++]=0;
	}
	function $f41(){
		//#line 18128: 2 copy 0 ne exch 0 ne and { 
		this.stk[this.ptr++]=2;
	...
	function $f42(){
		//#line 18136: /coeffs [ 1 ecpb {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f43(){
		//#line 18141: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18142: coeffs j coeffs j 1 sub get coeffs j get rsalog i get rsprod xor put
	...
	function $f44(){
		//#line 18138: /i exch def 
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18139: coeffs i 1 add coeffs i get put
		var t=this.dstk.get("coeffs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 18144: coeffs 0 coeffs 0 get rsalog i get rsprod put
		var t=this.dstk.get("coeffs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("coeffs");
	...
	function $f45(){
		//#line 18151: /rscws [ cwbs i get aload pop ecpb {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f46(){
		//#line 18156: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18157: rscws m j add 1 add coeffs ecpb j sub 1 sub get k rsprod rscws m j add 1 add get xor put
	...
	function $f47(){
		//#line 18153: /m exch def
		this.stk[this.ptr++]="m";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18154: /k rscws m get def
		this.stk[this.ptr++]="k";
		var t=this.dstk.get("rscws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("m");
	...
	function $f48(){
		...
		//#line 18160: ecbs i rscws dcpb ecpb getinterval put
	...
	function $f49(){
		//#line 18164: /cws [ cws aload pop rscw {0} repeat ] def
		this.stk[this.ptr++]=0;
	}
	function $f50(){
		//#line 18166: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18167: cws dcws i add ecbs i rsbl mod get i rsbl idiv get put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("dcws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f51(){
		//#line 18171: /mmat dcws rscw add stype {5} {8} ifelse mul array def
		this.stk[this.ptr++]=5;
	}
	function $f52(){
		//#line 18171: /mmat dcws rscw add stype {5} {8} ifelse mul array def
	...
	function $f53(){
		//#line 18173: 0 stype {2} {1} ifelse cws length 1 sub {
		this.stk[this.ptr++]=2;
	}
	function $f54(){
		//#line 18173: 0 stype {2} {1} ifelse cws length 1 sub {
	...
	function $f55(){
		//#line 18177: dup length 8 exch sub exch putinterval [ exch {48 sub} forall ]
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f56(){
		//#line 18176: (00000000) 8 string copy dup cws i get 2 8 string cvrs
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 18178: dup 0 4 getinterval /top exch def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18179: 4 4 getinterval /bot exch def
		this.stk[this.ptr++]=4;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	...
	function $f57(){
		//#line 18182: dup length 5 exch sub exch putinterval [ exch {48 sub} forall ]
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f58(){
		//#line 18185: dup length 5 exch sub exch putinterval [ exch {48 sub} forall ]
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f59(){
		//#line 18181: (00000) 5 string copy dup cws i get 2 5 string cvrs
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 18183: /c1 exch def
		this.stk[this.ptr++]="c1";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18184: (00000) 5 string copy dup cws i 1 add get 2 5 string cvrs
		this.stk[this.ptr++]=BWIPJS.psstring("00000");
		this.stk[this.ptr++]=5;
		this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
		if (typeof(this.stk[this.ptr-1])=="number") {
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 18186: /c2 exch def
		this.stk[this.ptr++]="c2";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18187: /top [ c1 0 3 getinterval aload pop c2 0 2 getinterval aload pop ] def
		this.stk[this.ptr++]="top";
		this.stk[this.ptr++]=Infinity;
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18188: /bot [ c1 3 2 getinterval aload pop c2 2 3 getinterval aload pop ] def
		this.stk[this.ptr++]="bot";
		this.stk[this.ptr++]=Infinity;
		var t=this.dstk.get("c1");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f60(){
		//#line 18193: c dcol eq {/c 0 def /r r 2 add def} if
		this.stk[this.ptr++]="c";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="r";
	...
	function $f61(){
		//#line 18174: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18175: stype not {
		...
		//#line 18190: mmat r dcol mul c add top putinterval
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18191: mmat r 1 add dcol mul c add bot putinterval
		var t=this.dstk.get("mmat");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("r");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 18192: /c c top length add def
		this.stk[this.ptr++]="c";
		var t=this.dstk.get("c");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("top");
	...
	function $f62(){
		//#line 18197: /mmv {cols mul add} bind def
	...
	function $f63(){
		//#line 18198: /pixs [ rows cols mul {-1} repeat ] def
		this.stk[this.ptr++]=-1;
	}
	function $f64(){
		//#line 18202: {cols {0} repeat} bind 
		this.stk[this.ptr++]=0;
	}
	function $f65(){
		//#line 18202: {cols {0} repeat} bind 
	...
	function $f68(){
		//#line 18204: {0   cols 2 sub {1} repeat   0} bind 
		this.stk[this.ptr++]=1;
	}
	function $f69(){
		//#line 18204: {0   cols 2 sub {1} repeat   0} bind 
	...
	function $f70(){
		//#line 18205: {0 1 cols 4 sub {0} repeat 1 0} bind 
		this.stk[this.ptr++]=0;
	}
	function $f71(){
		//#line 18205: {0 1 cols 4 sub {0} repeat 1 0} bind 
	...
	function $f72(){
		//#line 18206: {cols 1 sub 2 idiv {-1} repeat 1 cols 1 sub 2 idiv {-1} repeat} bind 
		this.stk[this.ptr++]=-1;
	}
	function $f73(){
		//#line 18206: {cols 1 sub 2 idiv {-1} repeat 1 cols 1 sub 2 idiv {-1} repeat} bind 
	...
	function $f75(){
		//#line 18207: {cols 1 sub 2 idiv {-1} repeat 0 cols 1 sub 2 idiv {-1} repeat} bind 
		this.stk[this.ptr++]=-1;
	}
	function $f76(){
		//#line 18207: {cols 1 sub 2 idiv {-1} repeat 0 cols 1 sub 2 idiv {-1} repeat} bind 
	...
	function $f78(){
		//#line 18208: {1   cols 2 sub {0} repeat   1} bind 
		this.stk[this.ptr++]=0;
	}
	function $f79(){
		//#line 18208: {1   cols 2 sub {0} repeat   1} bind 
	...
	function $f80(){
		//#line 18209: {1 0 cols 4 sub {1} repeat 0 1} bind 
		this.stk[this.ptr++]=1;
	}
	function $f81(){
		//#line 18209: {1 0 cols 4 sub {1} repeat 0 1} bind 
	...
	function $f82(){
		//#line 18224: [ cpat {artifact exch 49 sub get exec} forall ] putinterval
	...
	function $f83(){
		//#line 18231: [ 1 i 12 mod 0 eq {1} {0} ifelse ] dup
		this.stk[this.ptr++]=1;
	}
	function $f84(){
		//#line 18231: [ 1 i 12 mod 0 eq {1} {0} ifelse ] dup
	...
	function $f85(){
		//#line 18235: pixs cols j sub 2 sub rows i sub 1 sub mmv 
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18236: 3 -1 roll putinterval
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=-1;
		var b=this.stk[--this.ptr]; var a=this.stk[--this.ptr];
		if (a > this.ptr) throw "roll: underflow: this.ptr="+this.ptr+",offset="+a;
	...
	function $f86(){
		//#line 18237: } {pop} ifelse
		this.ptr--;
	}
	function $f87(){
		//#line 18230: /j exch def
		this.stk[this.ptr++]="j";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18231: [ 1 i 12 mod 0 eq {1} {0} ifelse ] dup
		...
		var t=this.dstk.get("mmv");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 18233: 3 -1 roll putinterval
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=-1;
		var b=this.stk[--this.ptr]; var a=this.stk[--this.ptr];
		if (a > this.ptr) throw "roll: underflow: this.ptr="+this.ptr+",offset="+a;
	...
	function $f88(){
		//#line 18228: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18229: riso risi cols 1 sub {
	...
	function $f89(){
		//#line 18257: >> vers get {pixs exch aload pop mmv 1 put} forall
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.stk[this.ptr-1];
	...
	function $f90(){
		//#line 18264: pixs i mmat j get put
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f91(){
		//#line 18262: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 18263: pixs i get -1 eq {
		var t=this.dstk.get("pixs");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 17967: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 17969: /options exch def
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17970: /barcode exch def
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17972: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17973: /version (unset) def
	this.stk[this.ptr++]="version";
	this.stk[this.ptr++]=BWIPJS.psstring("unset");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17974: /encoding (ascii) def
	this.stk[this.ptr++]="encoding";
	this.stk[this.ptr++]=BWIPJS.psstring("ascii");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17975: /raw false def
	this.stk[this.ptr++]="raw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17976: /parse false def
	this.stk[this.ptr++]="parse";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 17979: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 17989: /stype version 0 1 getinterval (S) eq def
	...
	//#line 18013: /barlen barcode length def
	...
	//#line 18108: /cwbs rsbl array def  % Array of data codeword blocks
	this.stk[this.ptr++]="cwbs";
	var t=this.dstk.get("rsbl");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18109: /ecbs rsbl array def  % Array of error correction blocks
	this.stk[this.ptr++]="ecbs";
	var t=this.dstk.get("rsbl");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18110: 0 1 rsbl 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("rsbl");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 18146: /coeffs coeffs 0 coeffs length 1 sub getinterval def
	this.stk[this.ptr++]="coeffs";
	var t=this.dstk.get("coeffs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18149: 0 1 cwbs length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("cwbs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18223: pixs 0 rows cpat length sub 2 idiv mmv 
	var t=this.dstk.get("pixs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	var t=this.dstk.get("rows");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 18248: /F [ [26 32] [70 32] [26 34] [70 34] ]
	this.stk[this.ptr++]="F";
	this.stk[this.ptr++]=Infinity;
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 18250: /H [ [26 70] [66 70] [106 70] [26 72] [66 72] [106 72] ]
	this.stk[this.ptr++]="H";
	this.stk[this.ptr++]=Infinity;
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 18256: /T-48 [ [24 10] [24 12] [24 14] ]
	...
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 18261: 0 1 pixs length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("pixs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 18270: <<
	this.stk[this.ptr++]=Infinity;
	//#line 18271: /ren //renmatrix
	this.stk[this.ptr++]="ren";
	var t=this.dstk.get("renmatrix");
	this.stk[this.ptr++]=t;
	//#line 18272: /pixs pixs
	this.stk[this.ptr++]="pixs";
	var t=this.dstk.get("pixs");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 18273: /pixx cols
	this.stk[this.ptr++]="pixx";
	var t=this.dstk.get("cols");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 18274: /pixy rows
	this.stk[this.ptr++]="pixy";
	var t=this.dstk.get("rows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 18275: /height rows 72 div 2 mul
	...
	this.stk[this.ptr++]=2;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	//#line 18276: /width cols 72 div 2 mul
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 18280: dontdraw not //renmatrix if
