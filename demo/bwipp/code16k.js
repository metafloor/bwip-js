...
BWIPJS.bwipp["code16k"]=function() {
	function $f0(){
		//#line 10472: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 10473: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 10475: currentdict end /options exch def
	...
	function $f5(){
		//#line 10477: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 10485: pos -1 ne {/rows 16 def} if
		this.stk[this.ptr++]="rows";
		this.stk[this.ptr++]=16;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f7(){
		//#line 10494: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		//#line 10495: length j add 1 add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 10496: pop
		this.ptr--;
		//#line 10497: dup 0 3 getinterval cvi msg exch j 1 sub exch put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		...
		this.ptr-=3;
		//#line 10498: dup length 3 sub 3 exch getinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=3;
	...
	function $f8(){
		//#line 10500: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 10501: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10502: /barcode msg 0 j getinterval def
	...
	function $f10(){
		//#line 10489: /msg barcode length string def
	...
	function $f11(){
		//#line 10565: encs j get dup type /stringtype eq {0 get} if  % convert string to ASCII if required
		this.stk[this.ptr++]=0;
	...
	function $f12(){
		...
		//#line 10566: charvals j get exch i put 
	...
	function $f13(){
		//#line 10561: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10562: /encs charmaps i get def
	...
	function $f14(){
		//#line 10573: raw {/encoding (raw) def} if
		this.stk[this.ptr++]="encoding";
		this.stk[this.ptr++]=BWIPJS.psstring("raw");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f15(){
		//#line 10579: i barlen eq {exit} if
		return -1;
	}
	function $f16(){
		//#line 10579: i barlen eq {exit} if
		...
		//#line 10580: /cw barcode i 1 add 3 getinterval cvi def
	...
	function $f17(){
		//#line 10576: /cws barlen array def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("barlen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10577: /i 0 def /j 0 def
		this.stk[this.ptr++]="i";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="j";
		...
		//#line 10585: /cws cws 0 j getinterval def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
	...
	function $f18(){
		//#line 10599: i barlen eq {exit} if
		return -1;
	}
	function $f19(){
		//#line 10603: /char fncvals barcode i 1 add 4 getinterval get def
	...
	function $f21(){
		//#line 10602: barcode i 1 add get 94 ne {
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f22(){
		...
		//#line 10600: /char barcode i get def
		this.stk[this.ptr++]="char";
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10601: parsefnc char 94 eq and i barlen 4 sub lt and {
	...
	function $f23(){
		//#line 10620: p msglen ge {exit} if
		return -1;
	}
	function $f24(){
		//#line 10622: dup setc exch known not {pop exit} if
		this.ptr--;
		return -1;
	}
	function $f25(){
		//#line 10625: s 2 mod 0 eq {/s s 1 add def} {exit} ifelse
		this.stk[this.ptr++]="s";
	...
	function $f30(){
		//#line 10636: seta exch get cws exch j exch put
	...
	function $f31(){
		//#line 10640: setb exch get cws exch j exch put
	...
	function $f33(){
		//#line 10647: aload pop 48 sub exch 48 sub 10 mul add
	...
	function $f34(){
		//#line 10644: dup type /arraytype ne {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr-1]=BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		//#line 10649: cws exch j exch put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("j");
	...
	function $f35(){
		//#line 10654: /anotb {dup seta exch known exch setb exch known not and} bind def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("seta");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f36(){
		//#line 10655: /bnota {dup setb exch known exch seta exch known not and} bind def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f37(){
		//#line 10658: /nextanotb [ msg length {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f38(){
		//#line 10659: /nextbnota [ msg length {0} repeat 9999 ] def
		this.stk[this.ptr++]=0;
	}
	function $f39(){
		//#line 10663: nextanotb i 0 put
	...
	function $f40(){
		//#line 10665: nextanotb i nextanotb i 1 add get 1 add put
		var t=this.dstk.get("nextanotb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f42(){
		//#line 10670: nextbnota i nextbnota i 1 add get 1 add put
		var t=this.dstk.get("nextbnota");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f43(){
		//#line 10661: /i exch def
		this.stk[this.ptr++]="i";
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10662: msg i get anotb {
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f44(){
		//#line 10675: /abeforeb {dup nextanotb exch get exch nextbnota exch get lt} bind def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("nextanotb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f45(){
		//#line 10676: /bbeforea {dup nextbnota exch get exch nextanotb exch get lt} bind def
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("nextbnota");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f46(){
		//#line 10686: cws 0 pos 10 idiv 1 sub put
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		...
		this.ptr-=3;
		//#line 10687: cws 1 pos 10 mod 1 sub put 
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("pos");
	...
	function $f47(){
		//#line 10695: /cset (setb) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setb");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10696: /mode 1 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10697: exit
	...
	function $f48(){
		//#line 10702: /cset (setc) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setc");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10703: /mode 4 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=4;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10704: /i 1 def
	...
	function $f49(){
		//#line 10701: msg 0 get fn1 eq 1 numsscr exch pop 2 ge and {
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f50(){
		//#line 10710: /cset (setb) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setb");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10711: /mode 3 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=3;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10712: /i 1 def
	...
	function $f51(){
		//#line 10718: /cset (setc) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setc");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10719: /mode 2 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10720: exit
	...
	function $f52(){
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10725: /cset (setc) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setc");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10726: /mode 5 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=5;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10727: /i 1 def
	...
	function $f53(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10734: /cset (setc) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setc");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10735: /mode 5 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=5;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10736: /i 1 def
	...
	function $f54(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10744: /cset (setc) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setc");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10745: /mode 6 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=6;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10746: /i 2 def
	...
	function $f55(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10755: /cset (setc) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setc");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10756: /mode 6 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=6;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10757: /i 2 def
	...
	function $f56(){
		//#line 10717: 0 numsscr exch pop dup 2 ge exch 2 mod 0 eq and {
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("numsscr");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 10723: 0 numsscr exch pop dup 3 ge exch 2 mod 1 eq and {
		this.stk[this.ptr++]=0;
		var t=this.dstk.get("numsscr");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 10731: setb msg 0 get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10732: 1 numsscr exch pop dup 2 ge exch 2 mod 0 eq and and {
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("numsscr");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 10740: setb msg 0 get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10741: 1 numsscr exch pop dup 3 ge exch 2 mod 1 eq and and {
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("numsscr");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		//#line 10750: setb msg 0 get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10751: setb msg 1 get known and
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10752: 2 numsscr exch pop dup 2 ge exch 2 mod 0 eq and and {
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("numsscr");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f57(){
		//#line 10763: /cset (seta) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("seta");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10764: /mode 0 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10765: exit
	...
	function $f58(){
		...
		//#line 10768: /cset (setb) def
		this.stk[this.ptr++]="cset";
		this.stk[this.ptr++]=BWIPJS.psstring("setb");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10769: /mode 1 def
		this.stk[this.ptr++]="mode";
		this.stk[this.ptr++]=1;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10770: exit
	...
	function $f59(){
		//#line 10774: i msglen eq {exit} if
		return -1;
	}
	function $f60(){
		//#line 10785: sb1 enca
	...
	function $f61(){
		...
		var t=this.dstk.get("bnota");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10784: i 1 add abeforeb and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f62(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10798: msg i 1 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f63(){
		...
		var t=this.dstk.get("bnota");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10794: msg i 1 add get bnota and
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10795: i 2 add abeforeb and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f66(){
		//#line 10819: msg i 2 getinterval encc
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f69(){
		...
		this.ptr--;
		//#line 10812: seta msg i 4 add get known and {
		var t=this.dstk.get("seta");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f71(){
		//#line 10836: msg i 2 getinterval encc
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f74(){
		...
		this.ptr--;
		//#line 10829: seta msg i 6 add get known and {
		var t=this.dstk.get("seta");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f76(){
		...
		//#line 10844: nums 4 ge nums 2 mod 0 eq and {
		var t=this.dstk.get("nums");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]>=this.stk[this.ptr-1]; this.ptr--;
	...
	function $f78(){
		...
		var t=this.dstk.get("anotb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10858: i 1 add bbeforea and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f79(){
		...
		var t=this.dstk.get("enca");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10872: msg i 1 add get enca
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f80(){
		...
		var t=this.dstk.get("anotb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10868: msg i 1 add get anotb and
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10869: i 2 add bbeforea and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f83(){
		//#line 10893: msg i 2 getinterval encc
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f86(){
		...
		this.ptr--;
		//#line 10886: setb msg i 4 add get known and {
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f88(){
		//#line 10910: msg i 2 getinterval encc
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f91(){
		...
		this.ptr--;
		//#line 10903: setb msg i 6 add get known and {
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f93(){
		...
		//#line 10918: nums 4 ge nums 2 mod 0 eq and {
		var t=this.dstk.get("nums");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=4;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]>=this.stk[this.ptr-1]; this.ptr--;
	...
	function $f95(){
		//#line 10935: msg i 2 getinterval encc
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f98(){
		//#line 10942: setb msg i get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10943: i 1 add numsscr exch pop dup 2 ge exch 2 mod 0 eq and and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f99(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10956: msg i 1 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f100(){
		//#line 10952: setb msg i get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10953: i 1 add numsscr exch pop dup 3 ge exch 2 mod 1 eq and and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f101(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10968: msg i 1 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f102(){
		//#line 10963: setb msg i get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10964: setb msg i 1 add get known and
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10965: i 2 add numsscr exch pop dup 2 ge exch 2 mod 0 eq and and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f103(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10980: msg i 1 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10981: msg i 2 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f104(){
		//#line 10975: setb msg i get known
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10976: setb msg i 1 add get known and
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10977: i 2 add numsscr exch pop dup 3 ge exch 2 mod 1 eq and and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f105(){
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10994: msg i 1 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.dstk.get("encb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 10995: msg i 2 add get encb
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f106(){
		//#line 10988: setb msg i get known 
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1]]!==undefined; this.ptr--;
		//#line 10989: setb msg i 1 add get known and
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10990: setb msg i 2 add get known and
		var t=this.dstk.get("setb");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		//#line 10991: i 3 add numsscr exch pop dup 2 ge exch 2 mod 0 eq and and {
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=3;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	...
	function $f110(){
		...
		//#line 10776: i numsscr /nums exch def /nchars exch def
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("numsscr");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f111(){
		...
		this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10597: /msg barlen array def
		this.stk[this.ptr++]="msg";
		var t=this.dstk.get("barlen");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10598: /i 0 def /j 0 def {
		this.stk[this.ptr++]="i";
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="j";
		...
		//#line 10613: /msg msg 0 j getinterval def
		this.stk[this.ptr++]="msg";
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10614: /msglen msg length def
		...
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10660: msg length 1 sub -1 0 {
		var t=this.dstk.get("msg");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10678: /cws barcode length 2 mul 3 add array def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("barcode");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		...
		//#line 11015: /cws cws 0 j getinterval def
		this.stk[this.ptr++]="cws";
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
	...
	function $f112(){
		//#line 11046: urows 0 ne urows r ne and {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f113(){
		//#line 11047: cws length dcws gt {/okay false def} if
		this.stk[this.ptr++]="okay";
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f114(){
		//#line 11048: okay {exit} if
		return -1;
	}
	function $f115(){
		//#line 11042: /m metrics i get def
		this.stk[this.ptr++]="m";
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 11043: /r    m 0 get def        % Columns in symbol
		this.stk[this.ptr++]="r";
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 11044: /dcws m 1 get def        % Data codewords in symbol
	...
	function $f116(){
		//#line 11053: /cws [ cws aload pop dcws cws length sub {103} repeat ] def
		this.stk[this.ptr++]=103;
	}
	function $f117(){
		//#line 11059: 0 0 1 dcws {dup 2 add exch cws exch get mul add} for 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f118(){
		//#line 11061: 0 0 1 dcws {dup 1 add exch cws exch get mul add} for 
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f119(){
		//#line 11099: /stopencs stopencsodd def
	...
	function $f120(){
		//#line 11101: /stopencs stopencseven def
		this.stk[this.ptr++]="stopencs";
	...
	function $f121(){
		//#line 11110: startencs i get {48 sub} forall
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f122(){
		//#line 11113: encs exch get {48 sub} forall
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f123(){
	...
	function $f124(){
		//#line 11115: stopencs i get {48 sub} forall
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f125(){
		//#line 11119: 1 sbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
		this.stk[this.ptr++]=1;
	}
	function $f126(){
		//#line 11119: 1 sbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
	...
	function $f130(){
		...
		//#line 11111: 1
		this.stk[this.ptr++]=1;
		//#line 11112: cws i 5 mul 5 getinterval {
		var t=this.dstk.get("cws");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		//#line 11120: counttomark 1 sub array astore exch pop exch pop
		for (var i=this.ptr-1; i>=0 && this.stk[i]!==Infinity; i--);
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 11121: rowbits i 3 -1 roll put
	...
	function $f131(){
		//#line 11126: 81 sepheight mul {1} repeat
		this.stk[this.ptr++]=1;
	}
	function $f132(){
		//#line 11129: rowheight {rowbits i get aload pop} repeat
		var t=this.dstk.get("rowbits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f133(){
		//#line 11130: sepheight {10 {0} repeat 70 {1} repeat 0} repeat
		this.stk[this.ptr++]=0;
	}
	function $f134(){
		//#line 11130: sepheight {10 {0} repeat 70 {1} repeat 0} repeat
	...
	function $f137(){
		//#line 11132: rowheight {rowbits r 1 sub get aload pop} repeat
		var t=this.dstk.get("rowbits");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("r");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f138(){
		//#line 11133: 81 sepheight mul {1} repeat
		this.stk[this.ptr++]=1;
	}
	//#line 10452: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 10454: /options exch def
	this.stk[this.ptr++]="options";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10455: /barcode exch def
	this.stk[this.ptr++]="barcode";
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10457: /dontdraw false def
	this.stk[this.ptr++]="dontdraw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10458: /mode -1 def
	this.stk[this.ptr++]="mode";
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10459: /pos -1 def
	this.stk[this.ptr++]="pos";
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10460: /rows 0 def
	this.stk[this.ptr++]="rows";
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10461: /rowheight 8 def
	this.stk[this.ptr++]="rowheight";
	this.stk[this.ptr++]=8;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10462: /sepheight 1 def
	this.stk[this.ptr++]="sepheight";
	this.stk[this.ptr++]=1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10463: /encoding (auto) def
	this.stk[this.ptr++]="encoding";
	this.stk[this.ptr++]=BWIPJS.psstring("auto");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10464: /raw false def
	this.stk[this.ptr++]="raw";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10465: /parse false def
	this.stk[this.ptr++]="parse";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10466: /parsefnc false def
	this.stk[this.ptr++]="parsefnc";
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10469: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.pstype(this.stk[this.ptr-1]);
	this.stk[this.ptr++]="stringtype";
	...
	//#line 10479: /mode mode cvi def
	this.stk[this.ptr++]="mode";
	var t=this.dstk.get("mode");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10480: /pos pos cvi def
	this.stk[this.ptr++]="pos";
	var t=this.dstk.get("pos");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10481: /rows rows cvi def
	this.stk[this.ptr++]="rows";
	var t=this.dstk.get("rows");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10482: /rowheight rowheight cvi def
	this.stk[this.ptr++]="rowheight";
	var t=this.dstk.get("rowheight");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10483: /sepheight sepheight cvi def
	this.stk[this.ptr++]="sepheight";
	var t=this.dstk.get("sepheight");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	...
	//#line 10508: /barlen barcode length def
	...
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10511: /swa  -1 def  /swb  -2 def  /swc  -3 def 
	...
	this.stk[this.ptr++]=-3;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10512: /sa1  -4 def  /sb1  -5 def  /sc1  -6 def 
	...
	this.stk[this.ptr++]=-6;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10513: /sa2  -7 def  /sb2  -8 def  /sc2  -9 def 
	...
	this.stk[this.ptr++]=-9;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10514: /pad -10 def  /sb3 -11 def  /sc3 -12 def
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10515: /fn1 -13 def  /fn2 -14 def  /fn3 -15 def  /fn4 -16 def
	...
	//#line 10523: [  41   41  (09) ]  [ (*)  (*)  (10) ]  [ (+)  (+)  (11) ]  % 9-11
	...
	//#line 10525: [ (/)  (/)  (15) ]  [ (0)  (0)  (16) ]  [ (1)  (1)  (17) ]  % 15-17
	...
	//#line 10526: [ (2)  (2)  (18) ]  [ (3)  (3)  (19) ]  [ (4)  (4)  (20) ]  % 18-20
	...
	//#line 10527: [ (5)  (5)  (21) ]  [ (6)  (6)  (22) ]  [ (7)  (7)  (23) ]  % 21-23
	...
	//#line 10528: [ (8)  (8)  (24) ]  [ (9)  (9)  (25) ]  [ (:)  (:)  (26) ]  % 24-26
	...
	//#line 10531: [ (A)  (A)  (33) ]  [ (B)  (B)  (34) ]  [ (C)  (C)  (35) ]  % 33-35
	...
	//#line 10532: [ (D)  (D)  (36) ]  [ (E)  (E)  (37) ]  [ (F)  (F)  (38) ]  % 36-38
	...
	//#line 10533: [ (G)  (G)  (39) ]  [ (H)  (H)  (40) ]  [ (I)  (I)  (41) ]  % 39-41
	...
	//#line 10534: [ (J)  (J)  (42) ]  [ (K)  (K)  (43) ]  [ (L)  (L)  (44) ]  % 42-44
	...
	//#line 10535: [ (M)  (M)  (45) ]  [ (N)  (N)  (46) ]  [ (O)  (O)  (47) ]  % 45-47
	...
	//#line 10536: [ (P)  (P)  (48) ]  [ (Q)  (Q)  (49) ]  [ (R)  (R)  (50) ]  % 48-50
	...
	//#line 10537: [ (S)  (S)  (51) ]  [ (T)  (T)  (52) ]  [ (U)  (U)  (53) ]  % 51-53
	...
	//#line 10538: [ (V)  (V)  (54) ]  [ (W)  (W)  (55) ]  [ (X)  (X)  (56) ]  % 54-56
	...
	//#line 10539: [ (Y)  (Y)  (57) ]  [ (Z)  (Z)  (58) ]  [ ([)  ([)  (59) ]  % 57-59
	...
	//#line 10540: [  92   92  (60) ]  [ (])  (])  (61) ]  [ (^)  (^)  (62) ]  % 60-62
	...
	//#line 10541: [ (_)  (_)  (63) ]  [   0  (`)  (64) ]  [   1  (a)  (65) ]  % 63-65
	...
	//#line 10542: [   2  (b)  (66) ]  [   3  (c)  (67) ]  [   4  (d)  (68) ]  % 66-68
	...
	//#line 10543: [   5  (e)  (69) ]  [   6  (f)  (70) ]  [   7  (g)  (71) ]  % 69-71
	...
	//#line 10544: [   8  (h)  (72) ]  [   9  (i)  (73) ]  [  10  (j)  (74) ]  % 72-74
	...
	//#line 10545: [  11  (k)  (75) ]  [  12  (l)  (76) ]  [  13  (m)  (77) ]  % 75-77
	...
	//#line 10546: [  14  (n)  (78) ]  [  15  (o)  (79) ]  [  16  (p)  (80) ]  % 78-80
	...
	//#line 10547: [  17  (q)  (81) ]  [  18  (r)  (82) ]  [  19  (s)  (83) ]  % 81-83
	...
	//#line 10548: [  20  (t)  (84) ]  [  21  (u)  (85) ]  [  22  (v)  (86) ]  % 84-86
	...
	//#line 10549: [  23  (w)  (87) ]  [  24  (x)  (88) ]  [  25  (y)  (89) ]  % 87-89
	...
	//#line 10550: [  26  (z)  (90) ]  [  27  ({)  (91) ]  [  28  (|)  (92) ]  % 90-92
	...
	//#line 10551: [  29  (})  (93) ]  [  30  (~)  (94) ]  [  31  127  (95) ]  % 93-95
	...
	//#line 10552: [ fn3  fn3  (96) ]  [ fn2  fn2  (97) ]  [ sb1  sa1  (98) ]  % 96-98
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("fn3");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("fn3");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 10553: [ swc  swc  (99) ]  [ swb  fn4  swb  ]  [ fn4  swa  swa  ]  % 99-101
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("swc");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("swc");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 10554: [ fn1  fn1  fn1  ]  [ pad  pad  pad  ]  [ sb2  sa2  sb1  ]  % 102-104
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("fn1");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("fn1");
	...
	this.ptr = i;
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	//#line 10555: [ sc2  sc2  sb2  ]  [ sc3  sc3  sb3  ]                      % 105-106
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("sc2");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("sc2");
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10559: /charvals [ 109 dict 109 dict 109 dict ] def
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10560: 0 1 charmaps length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("charmaps");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 10569: /seta charvals 0 get def
	...
	this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10570: /setb charvals 1 get def
	...
	this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10571: /setc charvals 2 get def
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 11056: /cws [ r 2 sub 7 mul mode add cws aload pop ] def
	this.stk[this.ptr++]="cws";
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("r");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 11060: 107 mod /c1 exch def
	...
	//#line 11062: c1 dcws 2 add mul add 107 mod /c2 exch def
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 11063: /cws [ cws aload pop c1 c2 ] def
	this.stk[this.ptr++]="cws";
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("cws");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 11066: /encs
	this.stk[this.ptr++]="encs";
	//#line 11067: [ (212222) (222122) (222221) (121223) (121322) (131222) (122213)
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 11098: pos -1 eq pos 10 idiv 2 mod 1 eq or {
	var t=this.dstk.get("pos");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=-1;
	if (this.stk[this.ptr-2] instanceof BWIPJS.psstring)
	...
	//#line 11105: /rowbits r array def
	this.stk[this.ptr++]="rowbits";
	var t=this.dstk.get("r");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 11106: 0 1 r 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("r");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 11137: <<
	this.stk[this.ptr++]=Infinity;
	//#line 11138: /ren //renmatrix
	this.stk[this.ptr++]="ren";
	var t=this.dstk.get("renmatrix");
	this.stk[this.ptr++]=t;
	//#line 11139: /pixs pixs
	this.stk[this.ptr++]="pixs";
	...
	this.stk[this.ptr++]=81;
	//#line 11141: /pixy pixs length 81 idiv
	...
	this.stk[this.ptr++]=81;
	this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	//#line 11142: /height pixs length 81 idiv 72 div
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 11143: /width 81 72 div
	this.stk[this.ptr++]="width";
	this.stk[this.ptr++]=81;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 11144: /opt options
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 11147: dontdraw not //renmatrix if
