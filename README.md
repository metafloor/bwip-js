...
difference is the use of the OCR-A and OCR-B fonts as the default in bwip-js.
...
* These defaults can be overridden by specifying the font name as one of the
